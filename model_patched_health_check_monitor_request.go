...
// checks if the PatchedHealthCheckMonitorRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedHealthCheckMonitorRequest{}

// PatchedHealthCheckMonitorRequest HealthCheckMonitor Serializer.
type PatchedHealthCheckMonitorRequest struct {
...
type _PatchedHealthCheckMonitorRequest PatchedHealthCheckMonitorRequest
...
func NewPatchedHealthCheckMonitorRequest() *PatchedHealthCheckMonitorRequest {
	this := PatchedHealthCheckMonitorRequest{}
	return &this
}
...
func (o *PatchedHealthCheckMonitorRequest) SetIntervalNil() {
	o.Interval.Set(nil)
}
...
func (o *PatchedHealthCheckMonitorRequest) SetRetryNil() {
	o.Retry.Set(nil)
}
...
func (o *PatchedHealthCheckMonitorRequest) SetTimeoutNil() {
	o.Timeout.Set(nil)
}
...
func (o *PatchedHealthCheckMonitorRequest) SetPortNil() {
	o.Port.Set(nil)
}
...
func (o *PatchedHealthCheckMonitorRequest) SetTenantNil() {
	o.Tenant.Set(nil)
}
...
func (o *PatchedHealthCheckMonitorRequest) GetTags() []ApprovalWorkflowStageResponseApprovalWorkflowStage {
...
// and a boolean to check if the value has been set.
func (o *PatchedHealthCheckMonitorRequest) GetTagsOk() ([]ApprovalWorkflowStageResponseApprovalWorkflowStage, bool) {
	if o == nil || IsNil(o.Tags) {
		return nil, false
	}
	return o.Tags, true
...
func (o *PatchedHealthCheckMonitorRequest) SetTags(v []ApprovalWorkflowStageResponseApprovalWorkflowStage) {
	o.Tags = v
}

func (o PatchedHealthCheckMonitorRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedHealthCheckMonitorRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedHealthCheckMonitorRequest) UnmarshalJSON(data []byte) (err error) {
	varPatchedHealthCheckMonitorRequest := _PatchedHealthCheckMonitorRequest{}

	err = json.Unmarshal(data, &varPatchedHealthCheckMonitorRequest)

	if err != nil {
		return err
	}

	*o = PatchedHealthCheckMonitorRequest(varPatchedHealthCheckMonitorRequest)
...
type NullablePatchedHealthCheckMonitorRequest struct {
	value *PatchedHealthCheckMonitorRequest
	isSet bool
}

func (v NullablePatchedHealthCheckMonitorRequest) Get() *PatchedHealthCheckMonitorRequest {
	return v.value
}

func (v *NullablePatchedHealthCheckMonitorRequest) Set(val *PatchedHealthCheckMonitorRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedHealthCheckMonitorRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedHealthCheckMonitorRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedHealthCheckMonitorRequest(val *PatchedHealthCheckMonitorRequest) *NullablePatchedHealthCheckMonitorRequest {
	return &NullablePatchedHealthCheckMonitorRequest{value: val, isSet: true}
}

func (v NullablePatchedHealthCheckMonitorRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedHealthCheckMonitorRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
