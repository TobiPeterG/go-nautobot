...
func (o *PatchedBulkWritableNoteRequest) GetUser() ApprovalWorkflowUser {
...
func (o *PatchedBulkWritableNoteRequest) GetUserOk() (*ApprovalWorkflowUser, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedBulkWritableNoteRequest) SetUser(v ApprovalWorkflowUser) {
	o.User.Set(&v)
}
