...
func (o *RelationshipRequest) GetId() string {
	if o == nil || IsNil(o.Id) {
		var ret string
		return ret
	}
...
func (o *RelationshipRequest) GetIdOk() (*string, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *RelationshipRequest) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *RelationshipRequest) SetId(v string) {
	o.Id = &v
}
