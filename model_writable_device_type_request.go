...
type WritableDeviceTypeRequest struct {
	...
	DeviceFamily NullableApprovalWorkflowUser `json:"device_family,omitempty"`
...
// SetDeviceFamily gets a reference to the given NullableApprovalWorkflowUser and assigns it to the DeviceFamily field.
