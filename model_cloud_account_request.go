...
// checks if the CloudAccountRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudAccountRequest{}
...
type _CloudAccountRequest CloudAccountRequest
...
func (o *CloudAccountRequest) SetSecretsGroupNil() {
...
func (o *CloudAccountRequest) GetTags() []ApprovalWorkflowStageResponseApprovalWorkflowStage {
...
// and a boolean to check if the value has been set.
func (o *CloudAccountRequest) GetTagsOk() ([]ApprovalWorkflowStageResponseApprovalWorkflowStage, bool) {
	if o == nil || IsNil(o.Tags) {
		return nil, false
	}
	return o.Tags, true
...
func (o *CloudAccountRequest) SetTags(v []ApprovalWorkflowStageResponseApprovalWorkflowStage) {
	o.Tags = v
}

func (o CloudAccountRequest) MarshalJSON() ([]byte, error) {
...
func (o CloudAccountRequest) ToMap() (map[string]interface{}, error) {
...
func (o *CloudAccountRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCloudAccountRequest := _CloudAccountRequest{}

	err = json.Unmarshal(data, &varCloudAccountRequest)

	if err != nil {
		return err
	}

	*o = CloudAccountRequest(varCloudAccountRequest)
...
type NullableCloudAccountRequest struct {
	value *CloudAccountRequest
	isSet bool
}

func (v NullableCloudAccountRequest) Get() *CloudAccountRequest {
	return v.value
}

func (v *NullableCloudAccountRequest) Set(val *CloudAccountRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudAccountRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudAccountRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudAccountRequest(val *CloudAccountRequest) *NullableCloudAccountRequest {
	return &NullableCloudAccountRequest{value: val, isSet: true}
}

func (v NullableCloudAccountRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudAccountRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
