...
func (o *PatchedWebhookRequest) GetId() string {
	if o == nil || IsNil(o.Id) {
		var ret string
		return ret
	}
...
func (o *PatchedWebhookRequest) GetIdOk() (*string, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *PatchedWebhookRequest) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *PatchedWebhookRequest) SetId(v string) {
	o.Id = &v
}
...
func (o *PatchedWebhookRequest) GetHttpMethod() HttpMethodEnum {
...
// and a boolean to check if the value has been set.
func (o *PatchedWebhookRequest) GetHttpMethodOk() (*HttpMethodEnum, bool) {
	if o == nil || IsNil(o.HttpMethod) {
		return nil, false
	}
...
func (o *PatchedWebhookRequest) SetHttpMethod(v HttpMethodEnum) {
	o.HttpMethod = &v
}
