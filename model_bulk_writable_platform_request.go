...
// checks if the BulkWritablePlatformRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkWritablePlatformRequest{}
...
type _BulkWritablePlatformRequest BulkWritablePlatformRequest
...
func NewBulkWritablePlatformRequest(id string, name string) *BulkWritablePlatformRequest {
	this := BulkWritablePlatformRequest{}
	this.Id = id
	this.Name = name
	return &this
}
...
func (o *BulkWritablePlatformRequest) SetManufacturerNil() {
...
func (o BulkWritablePlatformRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkWritablePlatformRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkWritablePlatformRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkWritablePlatformRequest := _BulkWritablePlatformRequest{}

	err = json.Unmarshal(data, &varBulkWritablePlatformRequest)

	if err != nil {
		return err
	}

	*o = BulkWritablePlatformRequest(varBulkWritablePlatformRequest)
...
type NullableBulkWritablePlatformRequest struct {
	value *BulkWritablePlatformRequest
	isSet bool
}

func (v NullableBulkWritablePlatformRequest) Get() *BulkWritablePlatformRequest {
	return v.value
}

func (v *NullableBulkWritablePlatformRequest) Set(val *BulkWritablePlatformRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkWritablePlatformRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkWritablePlatformRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkWritablePlatformRequest(val *BulkWritablePlatformRequest) *NullableBulkWritablePlatformRequest {
	return &NullableBulkWritablePlatformRequest{value: val, isSet: true}
}

func (v NullableBulkWritablePlatformRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkWritablePlatformRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
