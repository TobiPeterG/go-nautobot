...
type PatchedBulkWritableInterfaceRedundancyGroupRequest struct {
	...
	VirtualIp NullableApprovalWorkflowUser `json:"virtual_ip,omitempty"`
...
// SetVirtualIp gets a reference to the given NullableApprovalWorkflowUser and assigns it to the VirtualIp field.
