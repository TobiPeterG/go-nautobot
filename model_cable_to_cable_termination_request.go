...
// checks if the CableToCableTerminationRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CableToCableTerminationRequest{}

// CableToCableTerminationRequest Extends the built-in ModelSerializer to enforce calling full_clean() on a copy of the associated instance during validation. (DRF does not do this by default; see https://github.com/encode/django-rest-framework/issues/3144)
type CableToCableTerminationRequest struct {
...
type _CableToCableTerminationRequest CableToCableTerminationRequest
...
func NewCableToCableTerminationRequest(cableEnd CableEndEnum, cable BulkWritableCableRequestStatus) *CableToCableTerminationRequest {
	this := CableToCableTerminationRequest{}
...
func (o *CableToCableTerminationRequest) SetCircuitTerminationNil() {
...
func (o *CableToCableTerminationRequest) SetConsolePortNil() {
...
func (o *CableToCableTerminationRequest) SetConsoleServerPortNil() {
...
func (o *CableToCableTerminationRequest) SetFrontPortNil() {
	o.FrontPort.Set(nil)
}
...
func (o *CableToCableTerminationRequest) SetInterfaceNil() {
	o.Interface.Set(nil)
}
...
func (o *CableToCableTerminationRequest) SetPowerFeedNil() {
	o.PowerFeed.Set(nil)
}
...
func (o *CableToCableTerminationRequest) SetPowerOutletNil() {
...
func (o *CableToCableTerminationRequest) SetPowerPortNil() {
	o.PowerPort.Set(nil)
}
...
func (o *CableToCableTerminationRequest) SetRearPortNil() {
	o.RearPort.Set(nil)
}
...
func (o CableToCableTerminationRequest) MarshalJSON() ([]byte, error) {
...
func (o CableToCableTerminationRequest) ToMap() (map[string]interface{}, error) {
...
func (o *CableToCableTerminationRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCableToCableTerminationRequest := _CableToCableTerminationRequest{}

	err = json.Unmarshal(data, &varCableToCableTerminationRequest)

	if err != nil {
		return err
	}

	*o = CableToCableTerminationRequest(varCableToCableTerminationRequest)
...
type NullableCableToCableTerminationRequest struct {
	value *CableToCableTerminationRequest
	isSet bool
}

func (v NullableCableToCableTerminationRequest) Get() *CableToCableTerminationRequest {
	return v.value
}

func (v *NullableCableToCableTerminationRequest) Set(val *CableToCableTerminationRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCableToCableTerminationRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCableToCableTerminationRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCableToCableTerminationRequest(val *CableToCableTerminationRequest) *NullableCableToCableTerminationRequest {
	return &NullableCableToCableTerminationRequest{value: val, isSet: true}
}

func (v NullableCableToCableTerminationRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCableToCableTerminationRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
