...
// checks if the BulkWritableVPNPhase1PolicyRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkWritableVPNPhase1PolicyRequest{}

// BulkWritableVPNPhase1PolicyRequest VPNPhase1Policy Serializer.
type BulkWritableVPNPhase1PolicyRequest struct {
	Id string `json:"id"`
...
type _BulkWritableVPNPhase1PolicyRequest BulkWritableVPNPhase1PolicyRequest
...
func NewBulkWritableVPNPhase1PolicyRequest(id string, name string) *BulkWritableVPNPhase1PolicyRequest {
	this := BulkWritableVPNPhase1PolicyRequest{}
	this.Id = id
	this.Name = name
	return &this
}
...
func (o *BulkWritableVPNPhase1PolicyRequest) SetLifetimeSecondsNil() {
...
func (o *BulkWritableVPNPhase1PolicyRequest) SetLifetimeKbNil() {
...
func (o *BulkWritableVPNPhase1PolicyRequest) SetTenantNil() {
	o.Tenant.Set(nil)
}
...
func (o *BulkWritableVPNPhase1PolicyRequest) GetTags() []ApprovalWorkflowStageResponseApprovalWorkflowStage {
...
// and a boolean to check if the value has been set.
func (o *BulkWritableVPNPhase1PolicyRequest) GetTagsOk() ([]ApprovalWorkflowStageResponseApprovalWorkflowStage, bool) {
	if o == nil || IsNil(o.Tags) {
		return nil, false
	}
	return o.Tags, true
...
func (o *BulkWritableVPNPhase1PolicyRequest) SetTags(v []ApprovalWorkflowStageResponseApprovalWorkflowStage) {
	o.Tags = v
}

func (o BulkWritableVPNPhase1PolicyRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkWritableVPNPhase1PolicyRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkWritableVPNPhase1PolicyRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkWritableVPNPhase1PolicyRequest := _BulkWritableVPNPhase1PolicyRequest{}

	err = json.Unmarshal(data, &varBulkWritableVPNPhase1PolicyRequest)

	if err != nil {
		return err
	}

	*o = BulkWritableVPNPhase1PolicyRequest(varBulkWritableVPNPhase1PolicyRequest)
...
type NullableBulkWritableVPNPhase1PolicyRequest struct {
	value *BulkWritableVPNPhase1PolicyRequest
	isSet bool
}

func (v NullableBulkWritableVPNPhase1PolicyRequest) Get() *BulkWritableVPNPhase1PolicyRequest {
	return v.value
}

func (v *NullableBulkWritableVPNPhase1PolicyRequest) Set(val *BulkWritableVPNPhase1PolicyRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkWritableVPNPhase1PolicyRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkWritableVPNPhase1PolicyRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkWritableVPNPhase1PolicyRequest(val *BulkWritableVPNPhase1PolicyRequest) *NullableBulkWritableVPNPhase1PolicyRequest {
	return &NullableBulkWritableVPNPhase1PolicyRequest{value: val, isSet: true}
}

func (v NullableBulkWritableVPNPhase1PolicyRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkWritableVPNPhase1PolicyRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
