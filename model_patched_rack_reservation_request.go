...
type PatchedRackReservationRequest struct {
	...
	Rack *ApprovalWorkflowStageResponseApprovalWorkflowStage `json:"rack,omitempty"`
...
// SetRack gets a reference to the given ApprovalWorkflowStageResponseApprovalWorkflowStage and assigns it to the Rack field.
