...
type Platform struct {
	...
	// Dictionary of library-specific network drivers, derived from network_driver by the netutils library mapping or the NETWORK_DRIVERS setting.
	NetworkDriverMappings map[string]string `json:"network_driver_mappings"`
