...
type ObjectMetadataAssignedObject struct {
	...
	NestedInterfaceVDCAssignment *NestedInterfaceVDCAssignment
...
// NestedInterfaceVDCAssignmentAsObjectMetadataAssignedObject is a convenience function that returns NestedInterfaceVDCAssignment wrapped in ObjectMetadataAssignedObject
func NestedInterfaceVDCAssignmentAsObjectMetadataAssignedObject(v *NestedInterfaceVDCAssignment) ObjectMetadataAssignedObject {
	return ObjectMetadataAssignedObject{
		NestedInterfaceVDCAssignment: v,
	}
}
...
func (dst *ObjectMetadataAssignedObject) UnmarshalJSON(data []byte) error {
	...
	// try to unmarshal data into NestedInterfaceVDCAssignment
	err = newStrictDecoder(data).Decode(&dst.NestedInterfaceVDCAssignment)
	if err == nil {
		jsonNestedInterfaceVDCAssignment, _ := json.Marshal(dst.NestedInterfaceVDCAssignment)
		if string(jsonNestedInterfaceVDCAssignment) == "{}" { // empty struct
			dst.NestedInterfaceVDCAssignment = nil
		} else {
			if err = validator.Validate(dst.NestedInterfaceVDCAssignment); err != nil {
				dst.NestedInterfaceVDCAssignment = nil
			} else {
				match++
			}
...
func (src ObjectMetadataAssignedObject) MarshalJSON() ([]byte, error) {
	...
	if src.NestedInterfaceVDCAssignment != nil {
		return json.Marshal(&src.NestedInterfaceVDCAssignment)
	}
...
func (obj *ObjectMetadataAssignedObject) GetActualInstance() (interface{}) {
	...
	if obj.NestedInterfaceVDCAssignment != nil {
		return obj.NestedInterfaceVDCAssignment
	}
