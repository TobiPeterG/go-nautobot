...
`func (o *RackReservationRequest) GetId() string`

GetId returns the Id field if non-nil, zero value otherwise.

### GetIdOk

`func (o *RackReservationRequest) GetIdOk() (*string, bool)`
...
`func (o *RackReservationRequest) SetId(v string)`

SetId sets Id field to given value.

### HasId

`func (o *RackReservationRequest) HasId() bool`
