...
`func (o *PatchedClusterRequest) GetId() string`

GetId returns the Id field if non-nil, zero value otherwise.

### GetIdOk

`func (o *PatchedClusterRequest) GetIdOk() (*string, bool)`
...
`func (o *PatchedClusterRequest) SetId(v string)`

SetId sets Id field to given value.

### HasId

`func (o *PatchedClusterRequest) HasId() bool`
...
`func (o *PatchedClusterRequest) GetClusterGroup() ApprovalWorkflowUser`

GetClusterGroup returns the ClusterGroup field if non-nil, zero value otherwise.

### GetClusterGroupOk

`func (o *PatchedClusterRequest) GetClusterGroupOk() (*ApprovalWorkflowUser, bool)`
...
`func (o *PatchedClusterRequest) SetClusterGroup(v ApprovalWorkflowUser)`
...
`func (o *PatchedClusterRequest) GetTenant() ApprovalWorkflowUser`

GetTenant returns the Tenant field if non-nil, zero value otherwise.

### GetTenantOk

`func (o *PatchedClusterRequest) GetTenantOk() (*ApprovalWorkflowUser, bool)`
...
`func (o *PatchedClusterRequest) SetTenant(v ApprovalWorkflowUser)`
...
`func (o *PatchedClusterRequest) GetLocation() ApprovalWorkflowUser`

GetLocation returns the Location field if non-nil, zero value otherwise.

### GetLocationOk

`func (o *PatchedClusterRequest) GetLocationOk() (*ApprovalWorkflowUser, bool)`
...
`func (o *PatchedClusterRequest) SetLocation(v ApprovalWorkflowUser)`
...
`func (o *PatchedClusterRequest) GetRelationships() map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue`

GetRelationships returns the Relationships field if non-nil, zero value otherwise.

### GetRelationshipsOk

`func (o *PatchedClusterRequest) GetRelationshipsOk() (*map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue, bool)`
...
`func (o *PatchedClusterRequest) SetRelationships(v map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue)`
