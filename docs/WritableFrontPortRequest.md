...
`func (o *WritableFrontPortRequest) GetId() string`

GetId returns the Id field if non-nil, zero value otherwise.

### GetIdOk

`func (o *WritableFrontPortRequest) GetIdOk() (*string, bool)`
...
`func (o *WritableFrontPortRequest) SetId(v string)`

SetId sets Id field to given value.

### HasId

`func (o *WritableFrontPortRequest) HasId() bool`
