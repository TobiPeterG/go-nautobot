...
`func (o *PatchedContactRequest) GetId() string`

GetId returns the Id field if non-nil, zero value otherwise.

### GetIdOk

`func (o *PatchedContactRequest) GetIdOk() (*string, bool)`
...
`func (o *PatchedContactRequest) SetId(v string)`

SetId sets Id field to given value.

### HasId

`func (o *PatchedContactRequest) HasId() bool`
...
`func (o *PatchedContactRequest) GetRelationships() map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue`

GetRelationships returns the Relationships field if non-nil, zero value otherwise.

### GetRelationshipsOk

`func (o *PatchedContactRequest) GetRelationshipsOk() (*map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue, bool)`
...
`func (o *PatchedContactRequest) SetRelationships(v map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue)`
