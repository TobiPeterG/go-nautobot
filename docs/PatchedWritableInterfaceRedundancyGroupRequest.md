...
`func (o *PatchedWritableInterfaceRedundancyGroupRequest) GetId() string`

GetId returns the Id field if non-nil, zero value otherwise.

### GetIdOk

`func (o *PatchedWritableInterfaceRedundancyGroupRequest) GetIdOk() (*string, bool)`
...
`func (o *PatchedWritableInterfaceRedundancyGroupRequest) SetId(v string)`

SetId sets Id field to given value.

### HasId

`func (o *PatchedWritableInterfaceRedundancyGroupRequest) HasId() bool`
