...
`func NewConsoleServerPort(objectType string, display string, url string, naturalSlug string, cable map[string]interface{}, cablePeerType NullableString, cablePeer NullableCableTermination, connectedEndpointType NullableString, connectedEndpoint NullablePathEndpoint, connectedEndpointReachable NullableBool, name string, created NullableTime, lastUpdated NullableTime, notesUrl string, ) *ConsoleServerPort`
...
`func (o *ConsoleServerPort) GetCable() map[string]interface{}`

GetCable returns the Cable field if non-nil, zero value otherwise.

### GetCableOk

`func (o *ConsoleServerPort) GetCableOk() (*map[string]interface{}, bool)`
...
`func (o *ConsoleServerPort) SetCable(v map[string]interface{})`
...
`func (o *ConsoleServerPort) GetDevice() ApprovalWorkflowUser`

GetDevice returns the Device field if non-nil, zero value otherwise.

### GetDeviceOk

`func (o *ConsoleServerPort) GetDeviceOk() (*ApprovalWorkflowUser, bool)`
...
`func (o *ConsoleServerPort) SetDevice(v ApprovalWorkflowUser)`
...
`func (o *ConsoleServerPort) SetDeviceNil(b bool)`
...
`func (o *ConsoleServerPort) GetModule() ApprovalWorkflowUser`

GetModule returns the Module field if non-nil, zero value otherwise.

### GetModuleOk

`func (o *ConsoleServerPort) GetModuleOk() (*ApprovalWorkflowUser, bool)`
...
`func (o *ConsoleServerPort) SetModule(v ApprovalWorkflowUser)`
