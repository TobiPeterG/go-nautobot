...
`func (o *PatchedWritableConsolePortRequest) GetId() string`

GetId returns the Id field if non-nil, zero value otherwise.

### GetIdOk

`func (o *PatchedWritableConsolePortRequest) GetIdOk() (*string, bool)`
...
`func (o *PatchedWritableConsolePortRequest) SetId(v string)`

SetId sets Id field to given value.

### HasId

`func (o *PatchedWritableConsolePortRequest) HasId() bool`
...
`func (o *PatchedWritableConsolePortRequest) GetDevice() ApprovalWorkflowUser`

GetDevice returns the Device field if non-nil, zero value otherwise.

### GetDeviceOk

`func (o *PatchedWritableConsolePortRequest) GetDeviceOk() (*ApprovalWorkflowUser, bool)`
...
`func (o *PatchedWritableConsolePortRequest) SetDevice(v ApprovalWorkflowUser)`
...
`func (o *PatchedWritableConsolePortRequest) GetModule() ApprovalWorkflowUser`

GetModule returns the Module field if non-nil, zero value otherwise.

### GetModuleOk

`func (o *PatchedWritableConsolePortRequest) GetModuleOk() (*ApprovalWorkflowUser, bool)`
...
`func (o *PatchedWritableConsolePortRequest) SetModule(v ApprovalWorkflowUser)`
...
`func (o *PatchedWritableConsolePortRequest) GetRelationships() map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue`

GetRelationships returns the Relationships field if non-nil, zero value otherwise.

### GetRelationshipsOk

`func (o *PatchedWritableConsolePortRequest) GetRelationshipsOk() (*map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue, bool)`
...
`func (o *PatchedWritableConsolePortRequest) SetRelationships(v map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue)`
