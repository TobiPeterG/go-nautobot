...
[**CloudCloudNetworksNotesList**](CloudAPI.md#CloudCloudNetworksNotesList) | **Get** /cloud/cloud-networks/{id}/notes/ | 
...
[**CloudCloudServicesNotesCreate**](CloudAPI.md#CloudCloudServicesNotesCreate) | **Post** /cloud/cloud-services/{id}/notes/ | 
...
> CloudAccount CloudCloudAccountsCreate(ctx).CloudAccountRequest(cloudAccountRequest).Format(format).Execute()
...
Other parameters are passed through a pointer to a apiCloudCloudAccountsPartialUpdateRequest struct via the builder pattern
...
func main() {
	...
	// response from `CloudCloudNetworksList`: PaginatedCloudNetworkList
	fmt.Fprintf(os.Stdout, "Response from `CloudAPI.CloudCloudNetworksList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCloudCloudNetworksListRequest struct via the builder pattern
 ...
 **offset** | **int32** | The initial index from which to return the results. | 
 **parent** | **[]string** |  | 
 **parentIsnull** | **bool** | Parent cloud network (name or ID) is null | 
 **parentN** | **[]string** |  | 
 **prefixes** | **[]string** |  | 
 **prefixesN** | **[]string** |  | 
 **q** | **string** | Search | 
...
## CloudCloudNetworksNotesCreate

> Note CloudCloudNetworksNotesCreate(ctx, id).NoteInputRequest(noteInputRequest).Format(format).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CloudAPI.CloudCloudNetworksNotesCreate(context.Background(), id).NoteInputRequest(noteInputRequest).Format(format).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CloudAPI.CloudCloudNetworksNotesCreate``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CloudCloudNetworksNotesCreate`: Note
	fmt.Fprintf(os.Stdout, "Response from `CloudAPI.CloudCloudNetworksNotesCreate`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCloudCloudNetworksNotesCreateRequest struct via the builder pattern
...
func main() {
	...
	// response from `CloudCloudNetworksNotesList`: PaginatedNoteList
	fmt.Fprintf(os.Stdout, "Response from `CloudAPI.CloudCloudNetworksNotesList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCloudCloudNetworksNotesListRequest struct via the builder pattern
...
## CloudCloudNetworksPartialUpdate

> CloudNetwork CloudCloudNetworksPartialUpdate(ctx, id).Format(format).PatchedCloudNetworkRequest(patchedCloudNetworkRequest).Execute()
...
func main() {
	id := "38400000-8cf0-11bd-b23e-10b96e4ef00d" // string | A UUID string identifying this cloud network.
	format := openapiclient.circuits_circuit_terminations_list_format_parameter("csv") // CircuitsCircuitTerminationsListFormatParameter |  (optional)
	patchedCloudNetworkRequest := *openapiclient.NewPatchedCloudNetworkRequest() // PatchedCloudNetworkRequest |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CloudAPI.CloudCloudNetworksPartialUpdate(context.Background(), id).Format(format).PatchedCloudNetworkRequest(patchedCloudNetworkRequest).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CloudAPI.CloudCloudNetworksPartialUpdate``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CloudCloudNetworksPartialUpdate`: CloudNetwork
	fmt.Fprintf(os.Stdout, "Response from `CloudAPI.CloudCloudNetworksPartialUpdate`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCloudCloudNetworksPartialUpdateRequest struct via the builder pattern
 ...
 **format** | [**CircuitsCircuitTerminationsListFormatParameter**](CircuitsCircuitTerminationsListFormatParameter.md) |  | 
 **patchedCloudNetworkRequest** | [**PatchedCloudNetworkRequest**](PatchedCloudNetworkRequest.md) |  | 
...
func main() {
	...
	// response from `CloudCloudNetworksRetrieve`: CloudNetwork
	fmt.Fprintf(os.Stdout, "Response from `CloudAPI.CloudCloudNetworksRetrieve`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCloudCloudNetworksRetrieveRequest struct via the builder pattern
...
## CloudCloudNetworksUpdate

> CloudNetwork CloudCloudNetworksUpdate(ctx, id).CloudNetworkRequest(cloudNetworkRequest).Format(format).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CloudAPI.CloudCloudNetworksUpdate(context.Background(), id).CloudNetworkRequest(cloudNetworkRequest).Format(format).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CloudAPI.CloudCloudNetworksUpdate``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CloudCloudNetworksUpdate`: CloudNetwork
	fmt.Fprintf(os.Stdout, "Response from `CloudAPI.CloudCloudNetworksUpdate`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCloudCloudNetworksUpdateRequest struct via the builder pattern
...
## CloudCloudResourceTypesBulkDestroy

> CloudCloudResourceTypesBulkDestroy(ctx).BulkOperationRequest(bulkOperationRequest).Format(format).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.CloudAPI.CloudCloudResourceTypesBulkDestroy(context.Background()).BulkOperationRequest(bulkOperationRequest).Format(format).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CloudAPI.CloudCloudResourceTypesBulkDestroy``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
}
```
...
Other parameters are passed through a pointer to a apiCloudCloudResourceTypesBulkDestroyRequest struct via the builder pattern
...
## CloudCloudResourceTypesBulkPartialUpdate

> []CloudResourceType CloudCloudResourceTypesBulkPartialUpdate(ctx).PatchedBulkWritableCloudResourceTypeRequest(patchedBulkWritableCloudResourceTypeRequest).Format(format).Execute()
...
func main() {
	patchedBulkWritableCloudResourceTypeRequest := []openapiclient.PatchedBulkWritableCloudResourceTypeRequest{*openapiclient.NewPatchedBulkWritableCloudResourceTypeRequest("Id_example")} // []PatchedBulkWritableCloudResourceTypeRequest | 
	format := openapiclient.circuits_circuit_terminations_list_format_parameter("csv") // CircuitsCircuitTerminationsListFormatParameter |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CloudAPI.CloudCloudResourceTypesBulkPartialUpdate(context.Background()).PatchedBulkWritableCloudResourceTypeRequest(patchedBulkWritableCloudResourceTypeRequest).Format(format).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CloudAPI.CloudCloudResourceTypesBulkPartialUpdate``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CloudCloudResourceTypesBulkPartialUpdate`: []CloudResourceType
	fmt.Fprintf(os.Stdout, "Response from `CloudAPI.CloudCloudResourceTypesBulkPartialUpdate`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCloudCloudResourceTypesBulkPartialUpdateRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **patchedBulkWritableCloudResourceTypeRequest** | [**[]PatchedBulkWritableCloudResourceTypeRequest**](PatchedBulkWritableCloudResourceTypeRequest.md) |  | 
 **format** | [**CircuitsCircuitTerminationsListFormatParameter**](CircuitsCircuitTerminationsListFormatParameter.md) |  | 
...
## CloudCloudResourceTypesBulkUpdate

> []CloudResourceType CloudCloudResourceTypesBulkUpdate(ctx).BulkWritableCloudResourceTypeRequest(bulkWritableCloudResourceTypeRequest).Format(format).Execute()
...
func main() {
	bulkWritableCloudResourceTypeRequest := []openapiclient.BulkWritableCloudResourceTypeRequest{*openapiclient.NewBulkWritableCloudResourceTypeRequest("Id_example", []string{"ContentTypes_example"}, "Name_example", *openapiclient.NewBulkWritableCloudAccountRequestProvider())} // []BulkWritableCloudResourceTypeRequest | 
	format := openapiclient.circuits_circuit_terminations_list_format_parameter("csv") // CircuitsCircuitTerminationsListFormatParameter |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CloudAPI.CloudCloudResourceTypesBulkUpdate(context.Background()).BulkWritableCloudResourceTypeRequest(bulkWritableCloudResourceTypeRequest).Format(format).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CloudAPI.CloudCloudResourceTypesBulkUpdate``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CloudCloudResourceTypesBulkUpdate`: []CloudResourceType
	fmt.Fprintf(os.Stdout, "Response from `CloudAPI.CloudCloudResourceTypesBulkUpdate`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCloudCloudResourceTypesBulkUpdateRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **bulkWritableCloudResourceTypeRequest** | [**[]BulkWritableCloudResourceTypeRequest**](BulkWritableCloudResourceTypeRequest.md) |  | 
 **format** | [**CircuitsCircuitTerminationsListFormatParameter**](CircuitsCircuitTerminationsListFormatParameter.md) |  | 
...
## CloudCloudResourceTypesCreate

> CloudResourceType CloudCloudResourceTypesCreate(ctx).CloudResourceTypeRequest(cloudResourceTypeRequest).Format(format).Execute()
...
func main() {
	cloudResourceTypeRequest := *openapiclient.NewCloudResourceTypeRequest([]string{"ContentTypes_example"}, "Name_example", *openapiclient.NewBulkWritableCloudAccountRequestProvider()) // CloudResourceTypeRequest | 
	format := openapiclient.circuits_circuit_terminations_list_format_parameter("csv") // CircuitsCircuitTerminationsListFormatParameter |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CloudAPI.CloudCloudResourceTypesCreate(context.Background()).CloudResourceTypeRequest(cloudResourceTypeRequest).Format(format).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CloudAPI.CloudCloudResourceTypesCreate``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CloudCloudResourceTypesCreate`: CloudResourceType
	fmt.Fprintf(os.Stdout, "Response from `CloudAPI.CloudCloudResourceTypesCreate`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCloudCloudResourceTypesCreateRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **cloudResourceTypeRequest** | [**CloudResourceTypeRequest**](CloudResourceTypeRequest.md) |  | 
 **format** | [**CircuitsCircuitTerminationsListFormatParameter**](CircuitsCircuitTerminationsListFormatParameter.md) |  | 
...
## CloudCloudResourceTypesDestroy

> CloudCloudResourceTypesDestroy(ctx, id).Format(format).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.CloudAPI.CloudCloudResourceTypesDestroy(context.Background(), id).Format(format).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CloudAPI.CloudCloudResourceTypesDestroy``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**id** | **string** | A UUID string identifying this cloud resource type. | 

### Other Parameters

Other parameters are passed through a pointer to a apiCloudCloudResourceTypesDestroyRequest struct via the builder pattern
...
func main() {
	...
	// response from `CloudCloudResourceTypesList`: PaginatedCloudResourceTypeList
	fmt.Fprintf(os.Stdout, "Response from `CloudAPI.CloudCloudResourceTypesList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCloudCloudResourceTypesListRequest struct via the builder pattern
...
## CloudCloudResourceTypesNotesCreate

> Note CloudCloudResourceTypesNotesCreate(ctx, id).NoteInputRequest(noteInputRequest).Format(format).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CloudAPI.CloudCloudResourceTypesNotesCreate(context.Background(), id).NoteInputRequest(noteInputRequest).Format(format).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CloudAPI.CloudCloudResourceTypesNotesCreate``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CloudCloudResourceTypesNotesCreate`: Note
	fmt.Fprintf(os.Stdout, "Response from `CloudAPI.CloudCloudResourceTypesNotesCreate`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCloudCloudResourceTypesNotesCreateRequest struct via the builder pattern
...
func main() {
	...
	// response from `CloudCloudResourceTypesNotesList`: PaginatedNoteList
	fmt.Fprintf(os.Stdout, "Response from `CloudAPI.CloudCloudResourceTypesNotesList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCloudCloudResourceTypesNotesListRequest struct via the builder pattern
...
## CloudCloudResourceTypesPartialUpdate

> CloudResourceType CloudCloudResourceTypesPartialUpdate(ctx, id).Format(format).PatchedCloudResourceTypeRequest(patchedCloudResourceTypeRequest).Execute()
...
func main() {
	id := "38400000-8cf0-11bd-b23e-10b96e4ef00d" // string | A UUID string identifying this cloud resource type.
	format := openapiclient.circuits_circuit_terminations_list_format_parameter("csv") // CircuitsCircuitTerminationsListFormatParameter |  (optional)
	patchedCloudResourceTypeRequest := *openapiclient.NewPatchedCloudResourceTypeRequest() // PatchedCloudResourceTypeRequest |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CloudAPI.CloudCloudResourceTypesPartialUpdate(context.Background(), id).Format(format).PatchedCloudResourceTypeRequest(patchedCloudResourceTypeRequest).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CloudAPI.CloudCloudResourceTypesPartialUpdate``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CloudCloudResourceTypesPartialUpdate`: CloudResourceType
	fmt.Fprintf(os.Stdout, "Response from `CloudAPI.CloudCloudResourceTypesPartialUpdate`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCloudCloudResourceTypesPartialUpdateRequest struct via the builder pattern
 ...
 **format** | [**CircuitsCircuitTerminationsListFormatParameter**](CircuitsCircuitTerminationsListFormatParameter.md) |  | 
 **patchedCloudResourceTypeRequest** | [**PatchedCloudResourceTypeRequest**](PatchedCloudResourceTypeRequest.md) |  | 
...
func main() {
	...
	// response from `CloudCloudResourceTypesRetrieve`: CloudResourceType
	fmt.Fprintf(os.Stdout, "Response from `CloudAPI.CloudCloudResourceTypesRetrieve`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCloudCloudResourceTypesRetrieveRequest struct via the builder pattern
...
## CloudCloudResourceTypesUpdate

> CloudResourceType CloudCloudResourceTypesUpdate(ctx, id).CloudResourceTypeRequest(cloudResourceTypeRequest).Format(format).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CloudAPI.CloudCloudResourceTypesUpdate(context.Background(), id).CloudResourceTypeRequest(cloudResourceTypeRequest).Format(format).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CloudAPI.CloudCloudResourceTypesUpdate``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CloudCloudResourceTypesUpdate`: CloudResourceType
	fmt.Fprintf(os.Stdout, "Response from `CloudAPI.CloudCloudResourceTypesUpdate`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCloudCloudResourceTypesUpdateRequest struct via the builder pattern
...
## CloudCloudServiceNetworkAssignmentsBulkDestroy

> CloudCloudServiceNetworkAssignmentsBulkDestroy(ctx).BulkOperationRequest(bulkOperationRequest).Format(format).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.CloudAPI.CloudCloudServiceNetworkAssignmentsBulkDestroy(context.Background()).BulkOperationRequest(bulkOperationRequest).Format(format).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CloudAPI.CloudCloudServiceNetworkAssignmentsBulkDestroy``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
}
```
...
Other parameters are passed through a pointer to a apiCloudCloudServiceNetworkAssignmentsBulkDestroyRequest struct via the builder pattern
...
## CloudCloudServiceNetworkAssignmentsBulkPartialUpdate

> []CloudServiceNetworkAssignment CloudCloudServiceNetworkAssignmentsBulkPartialUpdate(ctx).PatchedBulkWritableCloudServiceNetworkAssignmentRequest(patchedBulkWritableCloudServiceNetworkAssignmentRequest).Format(format).Execute()
...
func main() {
	patchedBulkWritableCloudServiceNetworkAssignmentRequest := []openapiclient.PatchedBulkWritableCloudServiceNetworkAssignmentRequest{*openapiclient.NewPatchedBulkWritableCloudServiceNetworkAssignmentRequest("Id_example")} // []PatchedBulkWritableCloudServiceNetworkAssignmentRequest | 
	format := openapiclient.circuits_circuit_terminations_list_format_parameter("csv") // CircuitsCircuitTerminationsListFormatParameter |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CloudAPI.CloudCloudServiceNetworkAssignmentsBulkPartialUpdate(context.Background()).PatchedBulkWritableCloudServiceNetworkAssignmentRequest(patchedBulkWritableCloudServiceNetworkAssignmentRequest).Format(format).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CloudAPI.CloudCloudServiceNetworkAssignmentsBulkPartialUpdate``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CloudCloudServiceNetworkAssignmentsBulkPartialUpdate`: []CloudServiceNetworkAssignment
	fmt.Fprintf(os.Stdout, "Response from `CloudAPI.CloudCloudServiceNetworkAssignmentsBulkPartialUpdate`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCloudCloudServiceNetworkAssignmentsBulkPartialUpdateRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **patchedBulkWritableCloudServiceNetworkAssignmentRequest** | [**[]PatchedBulkWritableCloudServiceNetworkAssignmentRequest**](PatchedBulkWritableCloudServiceNetworkAssignmentRequest.md) |  | 
 **format** | [**CircuitsCircuitTerminationsListFormatParameter**](CircuitsCircuitTerminationsListFormatParameter.md) |  | 
...
## CloudCloudServiceNetworkAssignmentsBulkUpdate

> []CloudServiceNetworkAssignment CloudCloudServiceNetworkAssignmentsBulkUpdate(ctx).BulkWritableCloudServiceNetworkAssignmentRequest(bulkWritableCloudServiceNetworkAssignmentRequest).Format(format).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CloudAPI.CloudCloudServiceNetworkAssignmentsBulkUpdate(context.Background()).BulkWritableCloudServiceNetworkAssignmentRequest(bulkWritableCloudServiceNetworkAssignmentRequest).Format(format).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CloudAPI.CloudCloudServiceNetworkAssignmentsBulkUpdate``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CloudCloudServiceNetworkAssignmentsBulkUpdate`: []CloudServiceNetworkAssignment
	fmt.Fprintf(os.Stdout, "Response from `CloudAPI.CloudCloudServiceNetworkAssignmentsBulkUpdate`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCloudCloudServiceNetworkAssignmentsBulkUpdateRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **bulkWritableCloudServiceNetworkAssignmentRequest** | [**[]BulkWritableCloudServiceNetworkAssignmentRequest**](BulkWritableCloudServiceNetworkAssignmentRequest.md) |  | 
 **format** | [**CircuitsCircuitTerminationsListFormatParameter**](CircuitsCircuitTerminationsListFormatParameter.md) |  | 
...
## CloudCloudServiceNetworkAssignmentsCreate

> CloudServiceNetworkAssignment CloudCloudServiceNetworkAssignmentsCreate(ctx).CloudServiceNetworkAssignmentRequest(cloudServiceNetworkAssignmentRequest).Format(format).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CloudAPI.CloudCloudServiceNetworkAssignmentsCreate(context.Background()).CloudServiceNetworkAssignmentRequest(cloudServiceNetworkAssignmentRequest).Format(format).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CloudAPI.CloudCloudServiceNetworkAssignmentsCreate``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CloudCloudServiceNetworkAssignmentsCreate`: CloudServiceNetworkAssignment
	fmt.Fprintf(os.Stdout, "Response from `CloudAPI.CloudCloudServiceNetworkAssignmentsCreate`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCloudCloudServiceNetworkAssignmentsCreateRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **cloudServiceNetworkAssignmentRequest** | [**CloudServiceNetworkAssignmentRequest**](CloudServiceNetworkAssignmentRequest.md) |  | 
 **format** | [**CircuitsCircuitTerminationsListFormatParameter**](CircuitsCircuitTerminationsListFormatParameter.md) |  | 
...
## CloudCloudServiceNetworkAssignmentsDestroy

> CloudCloudServiceNetworkAssignmentsDestroy(ctx, id).Format(format).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.CloudAPI.CloudCloudServiceNetworkAssignmentsDestroy(context.Background(), id).Format(format).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CloudAPI.CloudCloudServiceNetworkAssignmentsDestroy``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
}
```
...
Other parameters are passed through a pointer to a apiCloudCloudServiceNetworkAssignmentsDestroyRequest struct via the builder pattern
...
func main() {
	...
	// response from `CloudCloudServiceNetworkAssignmentsList`: PaginatedCloudServiceNetworkAssignmentList
	fmt.Fprintf(os.Stdout, "Response from `CloudAPI.CloudCloudServiceNetworkAssignmentsList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCloudCloudServiceNetworkAssignmentsListRequest struct via the builder pattern
...
func main() {
	id := "38400000-8cf0-11bd-b23e-10b96e4ef00d" // string | A UUID string identifying this cloud service network assignment.
	format := openapiclient.circuits_circuit_terminations_list_format_parameter("csv") // CircuitsCircuitTerminationsListFormatParameter |  (optional)
	patchedCloudServiceNetworkAssignmentRequest := *openapiclient.NewPatchedCloudServiceNetworkAssignmentRequest() // PatchedCloudServiceNetworkAssignmentRequest |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CloudAPI.CloudCloudServiceNetworkAssignmentsPartialUpdate(context.Background(), id).Format(format).PatchedCloudServiceNetworkAssignmentRequest(patchedCloudServiceNetworkAssignmentRequest).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CloudAPI.CloudCloudServiceNetworkAssignmentsPartialUpdate``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CloudCloudServiceNetworkAssignmentsPartialUpdate`: CloudServiceNetworkAssignment
	fmt.Fprintf(os.Stdout, "Response from `CloudAPI.CloudCloudServiceNetworkAssignmentsPartialUpdate`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCloudCloudServiceNetworkAssignmentsPartialUpdateRequest struct via the builder pattern
 ...
 **format** | [**CircuitsCircuitTerminationsListFormatParameter**](CircuitsCircuitTerminationsListFormatParameter.md) |  | 
 **patchedCloudServiceNetworkAssignmentRequest** | [**PatchedCloudServiceNetworkAssignmentRequest**](PatchedCloudServiceNetworkAssignmentRequest.md) |  | 
...
func main() {
	...
	// response from `CloudCloudServiceNetworkAssignmentsRetrieve`: CloudServiceNetworkAssignment
	fmt.Fprintf(os.Stdout, "Response from `CloudAPI.CloudCloudServiceNetworkAssignmentsRetrieve`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCloudCloudServiceNetworkAssignmentsRetrieveRequest struct via the builder pattern
...
## CloudCloudServiceNetworkAssignmentsUpdate

> CloudServiceNetworkAssignment CloudCloudServiceNetworkAssignmentsUpdate(ctx, id).CloudServiceNetworkAssignmentRequest(cloudServiceNetworkAssignmentRequest).Format(format).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CloudAPI.CloudCloudServiceNetworkAssignmentsUpdate(context.Background(), id).CloudServiceNetworkAssignmentRequest(cloudServiceNetworkAssignmentRequest).Format(format).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CloudAPI.CloudCloudServiceNetworkAssignmentsUpdate``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CloudCloudServiceNetworkAssignmentsUpdate`: CloudServiceNetworkAssignment
	fmt.Fprintf(os.Stdout, "Response from `CloudAPI.CloudCloudServiceNetworkAssignmentsUpdate`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCloudCloudServiceNetworkAssignmentsUpdateRequest struct via the builder pattern
...
## CloudCloudServicesBulkDestroy

> CloudCloudServicesBulkDestroy(ctx).BulkOperationRequest(bulkOperationRequest).Format(format).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.CloudAPI.CloudCloudServicesBulkDestroy(context.Background()).BulkOperationRequest(bulkOperationRequest).Format(format).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CloudAPI.CloudCloudServicesBulkDestroy``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
}
```
...
Other parameters are passed through a pointer to a apiCloudCloudServicesBulkDestroyRequest struct via the builder pattern
...
## CloudCloudServicesBulkPartialUpdate

> []CloudService CloudCloudServicesBulkPartialUpdate(ctx).PatchedBulkWritableCloudServiceRequest(patchedBulkWritableCloudServiceRequest).Format(format).Execute()
...
func main() {
	patchedBulkWritableCloudServiceRequest := []openapiclient.PatchedBulkWritableCloudServiceRequest{*openapiclient.NewPatchedBulkWritableCloudServiceRequest("Id_example")} // []PatchedBulkWritableCloudServiceRequest | 
	format := openapiclient.circuits_circuit_terminations_list_format_parameter("csv") // CircuitsCircuitTerminationsListFormatParameter |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CloudAPI.CloudCloudServicesBulkPartialUpdate(context.Background()).PatchedBulkWritableCloudServiceRequest(patchedBulkWritableCloudServiceRequest).Format(format).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CloudAPI.CloudCloudServicesBulkPartialUpdate``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CloudCloudServicesBulkPartialUpdate`: []CloudService
	fmt.Fprintf(os.Stdout, "Response from `CloudAPI.CloudCloudServicesBulkPartialUpdate`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCloudCloudServicesBulkPartialUpdateRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **patchedBulkWritableCloudServiceRequest** | [**[]PatchedBulkWritableCloudServiceRequest**](PatchedBulkWritableCloudServiceRequest.md) |  | 
 **format** | [**CircuitsCircuitTerminationsListFormatParameter**](CircuitsCircuitTerminationsListFormatParameter.md) |  | 
...
## CloudCloudServicesBulkUpdate

> []CloudService CloudCloudServicesBulkUpdate(ctx).BulkWritableCloudServiceRequest(bulkWritableCloudServiceRequest).Format(format).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CloudAPI.CloudCloudServicesBulkUpdate(context.Background()).BulkWritableCloudServiceRequest(bulkWritableCloudServiceRequest).Format(format).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CloudAPI.CloudCloudServicesBulkUpdate``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CloudCloudServicesBulkUpdate`: []CloudService
	fmt.Fprintf(os.Stdout, "Response from `CloudAPI.CloudCloudServicesBulkUpdate`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCloudCloudServicesBulkUpdateRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **bulkWritableCloudServiceRequest** | [**[]BulkWritableCloudServiceRequest**](BulkWritableCloudServiceRequest.md) |  | 
 **format** | [**CircuitsCircuitTerminationsListFormatParameter**](CircuitsCircuitTerminationsListFormatParameter.md) |  | 
...
## CloudCloudServicesCreate

> CloudService CloudCloudServicesCreate(ctx).CloudServiceRequest(cloudServiceRequest).Format(format).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CloudAPI.CloudCloudServicesCreate(context.Background()).CloudServiceRequest(cloudServiceRequest).Format(format).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CloudAPI.CloudCloudServicesCreate``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CloudCloudServicesCreate`: CloudService
	fmt.Fprintf(os.Stdout, "Response from `CloudAPI.CloudCloudServicesCreate`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCloudCloudServicesCreateRequest struct via the builder pattern


Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **cloudServiceRequest** | [**CloudServiceRequest**](CloudServiceRequest.md) |  | 
 **format** | [**CircuitsCircuitTerminationsListFormatParameter**](CircuitsCircuitTerminationsListFormatParameter.md) |  | 
...
## CloudCloudServicesDestroy

> CloudCloudServicesDestroy(ctx, id).Format(format).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.CloudAPI.CloudCloudServicesDestroy(context.Background(), id).Format(format).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CloudAPI.CloudCloudServicesDestroy``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
}
```
...
------------- | ------------- | ------------- | -------------
**ctx** | **context.Context** | context for authentication, logging, cancellation, deadlines, tracing, etc.
**id** | **string** | A UUID string identifying this cloud service. | 

### Other Parameters

Other parameters are passed through a pointer to a apiCloudCloudServicesDestroyRequest struct via the builder pattern
...
func main() {
	...
	// response from `CloudCloudServicesList`: PaginatedCloudServiceList
	fmt.Fprintf(os.Stdout, "Response from `CloudAPI.CloudCloudServicesList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCloudCloudServicesListRequest struct via the builder pattern
...
## CloudCloudServicesNotesCreate

> Note CloudCloudServicesNotesCreate(ctx, id).NoteInputRequest(noteInputRequest).Format(format).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CloudAPI.CloudCloudServicesNotesCreate(context.Background(), id).NoteInputRequest(noteInputRequest).Format(format).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CloudAPI.CloudCloudServicesNotesCreate``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CloudCloudServicesNotesCreate`: Note
	fmt.Fprintf(os.Stdout, "Response from `CloudAPI.CloudCloudServicesNotesCreate`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCloudCloudServicesNotesCreateRequest struct via the builder pattern
...
func main() {
	...
	// response from `CloudCloudServicesNotesList`: PaginatedNoteList
	fmt.Fprintf(os.Stdout, "Response from `CloudAPI.CloudCloudServicesNotesList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCloudCloudServicesNotesListRequest struct via the builder pattern
...
## CloudCloudServicesPartialUpdate

> CloudService CloudCloudServicesPartialUpdate(ctx, id).Format(format).PatchedCloudServiceRequest(patchedCloudServiceRequest).Execute()
...
func main() {
	id := "38400000-8cf0-11bd-b23e-10b96e4ef00d" // string | A UUID string identifying this cloud service.
	format := openapiclient.circuits_circuit_terminations_list_format_parameter("csv") // CircuitsCircuitTerminationsListFormatParameter |  (optional)
	patchedCloudServiceRequest := *openapiclient.NewPatchedCloudServiceRequest() // PatchedCloudServiceRequest |  (optional)

	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CloudAPI.CloudCloudServicesPartialUpdate(context.Background(), id).Format(format).PatchedCloudServiceRequest(patchedCloudServiceRequest).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CloudAPI.CloudCloudServicesPartialUpdate``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CloudCloudServicesPartialUpdate`: CloudService
	fmt.Fprintf(os.Stdout, "Response from `CloudAPI.CloudCloudServicesPartialUpdate`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCloudCloudServicesPartialUpdateRequest struct via the builder pattern
 ...
 **format** | [**CircuitsCircuitTerminationsListFormatParameter**](CircuitsCircuitTerminationsListFormatParameter.md) |  | 
 **patchedCloudServiceRequest** | [**PatchedCloudServiceRequest**](PatchedCloudServiceRequest.md) |  | 
...
func main() {
	...
	// response from `CloudCloudServicesRetrieve`: CloudService
	fmt.Fprintf(os.Stdout, "Response from `CloudAPI.CloudCloudServicesRetrieve`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCloudCloudServicesRetrieveRequest struct via the builder pattern
...
## CloudCloudServicesUpdate

> CloudService CloudCloudServicesUpdate(ctx, id).CloudServiceRequest(cloudServiceRequest).Format(format).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CloudAPI.CloudCloudServicesUpdate(context.Background(), id).CloudServiceRequest(cloudServiceRequest).Format(format).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CloudAPI.CloudCloudServicesUpdate``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CloudCloudServicesUpdate`: CloudService
	fmt.Fprintf(os.Stdout, "Response from `CloudAPI.CloudCloudServicesUpdate`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiCloudCloudServicesUpdateRequest struct via the builder pattern
