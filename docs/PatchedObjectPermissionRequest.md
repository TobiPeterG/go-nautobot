...
`func (o *PatchedObjectPermissionRequest) GetId() string`

GetId returns the Id field if non-nil, zero value otherwise.

### GetIdOk

`func (o *PatchedObjectPermissionRequest) GetIdOk() (*string, bool)`
...
`func (o *PatchedObjectPermissionRequest) SetId(v string)`

SetId sets Id field to given value.

### HasId

`func (o *PatchedObjectPermissionRequest) HasId() bool`
