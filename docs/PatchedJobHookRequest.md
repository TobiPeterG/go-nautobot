...
`func (o *PatchedJobHookRequest) GetId() string`

GetId returns the Id field if non-nil, zero value otherwise.

### GetIdOk

`func (o *PatchedJobHookRequest) GetIdOk() (*string, bool)`
...
`func (o *PatchedJobHookRequest) SetId(v string)`

SetId sets Id field to given value.

### HasId

`func (o *PatchedJobHookRequest) HasId() bool`
...
`func (o *PatchedJobHookRequest) GetRelationships() map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue`

GetRelationships returns the Relationships field if non-nil, zero value otherwise.

### GetRelationshipsOk

`func (o *PatchedJobHookRequest) GetRelationshipsOk() (*map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue, bool)`
...
`func (o *PatchedJobHookRequest) SetRelationships(v map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue)`
