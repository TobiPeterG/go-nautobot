...
`func (o *PatchedDynamicGroupRequest) GetId() string`

GetId returns the Id field if non-nil, zero value otherwise.

### GetIdOk

`func (o *PatchedDynamicGroupRequest) GetIdOk() (*string, bool)`
...
`func (o *PatchedDynamicGroupRequest) SetId(v string)`

SetId sets Id field to given value.

### HasId

`func (o *PatchedDynamicGroupRequest) HasId() bool`
...
`func (o *PatchedDynamicGroupRequest) GetTenant() ApprovalWorkflowUser`

GetTenant returns the Tenant field if non-nil, zero value otherwise.

### GetTenantOk

`func (o *PatchedDynamicGroupRequest) GetTenantOk() (*ApprovalWorkflowUser, bool)`
...
`func (o *PatchedDynamicGroupRequest) SetTenant(v ApprovalWorkflowUser)`
...
`func (o *PatchedDynamicGroupRequest) GetRelationships() map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue`

GetRelationships returns the Relationships field if non-nil, zero value otherwise.

### GetRelationshipsOk

`func (o *PatchedDynamicGroupRequest) GetRelationshipsOk() (*map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue, bool)`
...
`func (o *PatchedDynamicGroupRequest) SetRelationships(v map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue)`
