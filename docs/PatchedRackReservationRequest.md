...
`func (o *PatchedRackReservationRequest) GetId() string`

GetId returns the Id field if non-nil, zero value otherwise.

### GetIdOk

`func (o *PatchedRackReservationRequest) GetIdOk() (*string, bool)`
...
`func (o *PatchedRackReservationRequest) SetId(v string)`

SetId sets Id field to given value.

### HasId

`func (o *PatchedRackReservationRequest) HasId() bool`
...
`func (o *PatchedRackReservationRequest) GetTenant() ApprovalWorkflowUser`

GetTenant returns the Tenant field if non-nil, zero value otherwise.

### GetTenantOk

`func (o *PatchedRackReservationRequest) GetTenantOk() (*ApprovalWorkflowUser, bool)`
...
`func (o *PatchedRackReservationRequest) SetTenant(v ApprovalWorkflowUser)`
...
`func (o *PatchedRackReservationRequest) GetRelationships() map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue`

GetRelationships returns the Relationships field if non-nil, zero value otherwise.

### GetRelationshipsOk

`func (o *PatchedRackReservationRequest) GetRelationshipsOk() (*map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue, bool)`
...
`func (o *PatchedRackReservationRequest) SetRelationships(v map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue)`
