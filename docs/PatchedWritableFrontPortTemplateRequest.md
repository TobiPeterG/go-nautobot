...
`func (o *PatchedWritableFrontPortTemplateRequest) GetId() string`

GetId returns the Id field if non-nil, zero value otherwise.

### GetIdOk

`func (o *PatchedWritableFrontPortTemplateRequest) GetIdOk() (*string, bool)`
...
`func (o *PatchedWritableFrontPortTemplateRequest) SetId(v string)`

SetId sets Id field to given value.

### HasId

`func (o *PatchedWritableFrontPortTemplateRequest) HasId() bool`
...
`func (o *PatchedWritableFrontPortTemplateRequest) GetDeviceType() ApprovalWorkflowUser`

GetDeviceType returns the DeviceType field if non-nil, zero value otherwise.

### GetDeviceTypeOk

`func (o *PatchedWritableFrontPortTemplateRequest) GetDeviceTypeOk() (*ApprovalWorkflowUser, bool)`
...
`func (o *PatchedWritableFrontPortTemplateRequest) SetDeviceType(v ApprovalWorkflowUser)`
...
`func (o *PatchedWritableFrontPortTemplateRequest) GetModuleType() ApprovalWorkflowUser`

GetModuleType returns the ModuleType field if non-nil, zero value otherwise.

### GetModuleTypeOk

`func (o *PatchedWritableFrontPortTemplateRequest) GetModuleTypeOk() (*ApprovalWorkflowUser, bool)`
...
`func (o *PatchedWritableFrontPortTemplateRequest) SetModuleType(v ApprovalWorkflowUser)`
...
`func (o *PatchedWritableFrontPortTemplateRequest) GetRelationships() map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue`

GetRelationships returns the Relationships field if non-nil, zero value otherwise.

### GetRelationshipsOk

`func (o *PatchedWritableFrontPortTemplateRequest) GetRelationshipsOk() (*map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue, bool)`
...
`func (o *PatchedWritableFrontPortTemplateRequest) SetRelationships(v map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue)`
