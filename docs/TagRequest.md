...
`func (o *TagRequest) GetIdOk() (*string, bool)`
...
`func (o *TagRequest) SetId(v string)`

SetId sets Id field to given value.

### HasId

`func (o *TagRequest) HasId() bool`
...
`func (o *TagRequest) GetRelationships() map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue`

GetRelationships returns the Relationships field if non-nil, zero value otherwise.

### GetRelationshipsOk

`func (o *TagRequest) GetRelationshipsOk() (*map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue, bool)`
...
`func (o *TagRequest) SetRelationships(v map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue)`
