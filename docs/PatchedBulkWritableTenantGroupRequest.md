...
`func (o *PatchedBulkWritableTenantGroupRequest) GetParent() ApprovalWorkflowUser`

GetParent returns the Parent field if non-nil, zero value otherwise.

### GetParentOk

`func (o *PatchedBulkWritableTenantGroupRequest) GetParentOk() (*ApprovalWorkflowUser, bool)`
...
`func (o *PatchedBulkWritableTenantGroupRequest) SetParent(v ApprovalWorkflowUser)`
...
`func (o *PatchedBulkWritableTenantGroupRequest) GetRelationships() map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue`

GetRelationships returns the Relationships field if non-nil, zero value otherwise.

### GetRelationshipsOk

`func (o *PatchedBulkWritableTenantGroupRequest) GetRelationshipsOk() (*map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue, bool)`
...
`func (o *PatchedBulkWritableTenantGroupRequest) SetRelationships(v map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue)`
