...
`func NewWritableRearPortTemplateRequest(name string, type_ PortTypeChoices, ) *WritableRearPortTemplateRequest`
...
`func (o *WritableRearPortTemplateRequest) GetId() string`

GetId returns the Id field if non-nil, zero value otherwise.

### GetIdOk

`func (o *WritableRearPortTemplateRequest) GetIdOk() (*string, bool)`
...
`func (o *WritableRearPortTemplateRequest) SetId(v string)`

SetId sets Id field to given value.

### HasId

`func (o *WritableRearPortTemplateRequest) HasId() bool`
