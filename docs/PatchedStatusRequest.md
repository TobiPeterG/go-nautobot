...
`func (o *PatchedStatusRequest) GetId() string`

GetId returns the Id field if non-nil, zero value otherwise.

### GetIdOk

`func (o *PatchedStatusRequest) GetIdOk() (*string, bool)`
...
`func (o *PatchedStatusRequest) SetId(v string)`

SetId sets Id field to given value.

### HasId

`func (o *PatchedStatusRequest) HasId() bool`
...
`func (o *PatchedStatusRequest) GetRelationships() map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue`

GetRelationships returns the Relationships field if non-nil, zero value otherwise.

### GetRelationshipsOk

`func (o *PatchedStatusRequest) GetRelationshipsOk() (*map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue, bool)`
...
`func (o *PatchedStatusRequest) SetRelationships(v map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue)`
