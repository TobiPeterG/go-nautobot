...
`func (o *PatchedSecretsGroupRequest) GetId() string`

GetId returns the Id field if non-nil, zero value otherwise.

### GetIdOk

`func (o *PatchedSecretsGroupRequest) GetIdOk() (*string, bool)`
...
`func (o *PatchedSecretsGroupRequest) SetId(v string)`

SetId sets Id field to given value.

### HasId

`func (o *PatchedSecretsGroupRequest) HasId() bool`
...
`func (o *PatchedSecretsGroupRequest) GetRelationships() map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue`

GetRelationships returns the Relationships field if non-nil, zero value otherwise.

### GetRelationshipsOk

`func (o *PatchedSecretsGroupRequest) GetRelationshipsOk() (*map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue, bool)`
...
`func (o *PatchedSecretsGroupRequest) SetRelationships(v map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue)`
