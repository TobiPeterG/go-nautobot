...
`func (o *PatchedClusterGroupRequest) GetId() string`

GetId returns the Id field if non-nil, zero value otherwise.

### GetIdOk

`func (o *PatchedClusterGroupRequest) GetIdOk() (*string, bool)`
...
`func (o *PatchedClusterGroupRequest) SetId(v string)`

SetId sets Id field to given value.

### HasId

`func (o *PatchedClusterGroupRequest) HasId() bool`
...
`func (o *PatchedClusterGroupRequest) GetRelationships() map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue`

GetRelationships returns the Relationships field if non-nil, zero value otherwise.

### GetRelationshipsOk

`func (o *PatchedClusterGroupRequest) GetRelationshipsOk() (*map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue, bool)`
...
`func (o *PatchedClusterGroupRequest) SetRelationships(v map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue)`
