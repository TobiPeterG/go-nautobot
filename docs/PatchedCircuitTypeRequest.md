...
`func (o *PatchedCircuitTypeRequest) GetId() string`

GetId returns the Id field if non-nil, zero value otherwise.

### GetIdOk

`func (o *PatchedCircuitTypeRequest) GetIdOk() (*string, bool)`
...
`func (o *PatchedCircuitTypeRequest) SetId(v string)`

SetId sets Id field to given value.

### HasId

`func (o *PatchedCircuitTypeRequest) HasId() bool`
...
`func (o *PatchedCircuitTypeRequest) GetRelationships() map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue`

GetRelationships returns the Relationships field if non-nil, zero value otherwise.

### GetRelationshipsOk

`func (o *PatchedCircuitTypeRequest) GetRelationshipsOk() (*map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue, bool)`
...
`func (o *PatchedCircuitTypeRequest) SetRelationships(v map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue)`
