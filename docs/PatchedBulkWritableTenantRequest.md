...
`func (o *PatchedBulkWritableTenantRequest) GetTenantGroup() ApprovalWorkflowUser`

GetTenantGroup returns the TenantGroup field if non-nil, zero value otherwise.

### GetTenantGroupOk

`func (o *PatchedBulkWritableTenantRequest) GetTenantGroupOk() (*ApprovalWorkflowUser, bool)`
...
`func (o *PatchedBulkWritableTenantRequest) SetTenantGroup(v ApprovalWorkflowUser)`
...
`func (o *PatchedBulkWritableTenantRequest) GetRelationships() map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue`

GetRelationships returns the Relationships field if non-nil, zero value otherwise.

### GetRelationshipsOk

`func (o *PatchedBulkWritableTenantRequest) GetRelationshipsOk() (*map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue, bool)`
...
`func (o *PatchedBulkWritableTenantRequest) SetRelationships(v map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue)`
