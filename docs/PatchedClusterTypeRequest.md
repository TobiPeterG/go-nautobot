...
`func (o *PatchedClusterTypeRequest) GetId() string`

GetId returns the Id field if non-nil, zero value otherwise.

### GetIdOk

`func (o *PatchedClusterTypeRequest) GetIdOk() (*string, bool)`
...
`func (o *PatchedClusterTypeRequest) SetId(v string)`

SetId sets Id field to given value.

### HasId

`func (o *PatchedClusterTypeRequest) HasId() bool`
...
`func (o *PatchedClusterTypeRequest) GetRelationships() map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue`

GetRelationships returns the Relationships field if non-nil, zero value otherwise.

### GetRelationshipsOk

`func (o *PatchedClusterTypeRequest) GetRelationshipsOk() (*map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue, bool)`
...
`func (o *PatchedClusterTypeRequest) SetRelationships(v map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue)`
