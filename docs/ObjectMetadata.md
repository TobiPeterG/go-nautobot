...
`func (o *ObjectMetadata) GetContact() ApprovalWorkflowUser`

GetContact returns the Contact field if non-nil, zero value otherwise.

### GetContactOk

`func (o *ObjectMetadata) GetContactOk() (*ApprovalWorkflowUser, bool)`
...
`func (o *ObjectMetadata) SetContact(v ApprovalWorkflowUser)`
...
`func (o *ObjectMetadata) GetTeam() ApprovalWorkflowUser`

GetTeam returns the Team field if non-nil, zero value otherwise.

### GetTeamOk

`func (o *ObjectMetadata) GetTeamOk() (*ApprovalWorkflowUser, bool)`
...
`func (o *ObjectMetadata) SetTeam(v ApprovalWorkflowUser)`
