...
`func (o *SoftwareVersionRequest) GetId() string`

GetId returns the Id field if non-nil, zero value otherwise.

### GetIdOk

`func (o *SoftwareVersionRequest) GetIdOk() (*string, bool)`
...
`func (o *SoftwareVersionRequest) SetId(v string)`

SetId sets Id field to given value.

### HasId

`func (o *SoftwareVersionRequest) HasId() bool`
...
`func (o *SoftwareVersionRequest) GetRelationships() map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue`

GetRelationships returns the Relationships field if non-nil, zero value otherwise.

### GetRelationshipsOk

`func (o *SoftwareVersionRequest) GetRelationshipsOk() (*map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue, bool)`
...
`func (o *SoftwareVersionRequest) SetRelationships(v map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue)`
