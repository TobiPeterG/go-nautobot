...
`func (o *PatchedVirtualChassisRequest) GetId() string`

GetId returns the Id field if non-nil, zero value otherwise.

### GetIdOk

`func (o *PatchedVirtualChassisRequest) GetIdOk() (*string, bool)`
...
`func (o *PatchedVirtualChassisRequest) SetId(v string)`

SetId sets Id field to given value.

### HasId

`func (o *PatchedVirtualChassisRequest) HasId() bool`
