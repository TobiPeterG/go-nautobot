...
`func (o *PatchedTenantRequest) GetId() string`

GetId returns the Id field if non-nil, zero value otherwise.

### GetIdOk

`func (o *PatchedTenantRequest) GetIdOk() (*string, bool)`
...
`func (o *PatchedTenantRequest) SetId(v string)`

SetId sets Id field to given value.

### HasId

`func (o *PatchedTenantRequest) HasId() bool`
