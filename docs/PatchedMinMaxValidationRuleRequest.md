...
`func (o *PatchedMinMaxValidationRuleRequest) GetTags() []BulkWritableCableRequestStatus`

GetTags returns the Tags field if non-nil, zero value otherwise.

### GetTagsOk

`func (o *PatchedMinMaxValidationRuleRequest) GetTagsOk() (*[]BulkWritableCableRequestStatus, bool)`
...
`func (o *PatchedMinMaxValidationRuleRequest) SetTags(v []BulkWritableCableRequestStatus)`
