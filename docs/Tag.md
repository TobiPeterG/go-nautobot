...
`func NewTag(objectType string, display string, url string, naturalSlug string, taggedItems int32, contentTypes []string, name string, created NullableTime, lastUpdated NullableTime, notesUrl string, ) *Tag`
