...
`func (o *PatchedBulkWritableRearPortRequest) GetDevice() ApprovalWorkflowUser`

GetDevice returns the Device field if non-nil, zero value otherwise.

### GetDeviceOk

`func (o *PatchedBulkWritableRearPortRequest) GetDeviceOk() (*ApprovalWorkflowUser, bool)`
...
`func (o *PatchedBulkWritableRearPortRequest) SetDevice(v ApprovalWorkflowUser)`
...
`func (o *PatchedBulkWritableRearPortRequest) GetModule() ApprovalWorkflowUser`

GetModule returns the Module field if non-nil, zero value otherwise.

### GetModuleOk

`func (o *PatchedBulkWritableRearPortRequest) GetModuleOk() (*ApprovalWorkflowUser, bool)`
...
`func (o *PatchedBulkWritableRearPortRequest) SetModule(v ApprovalWorkflowUser)`
...
`func (o *PatchedBulkWritableRearPortRequest) GetRelationships() map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue`

GetRelationships returns the Relationships field if non-nil, zero value otherwise.

### GetRelationshipsOk

`func (o *PatchedBulkWritableRearPortRequest) GetRelationshipsOk() (*map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue, bool)`
...
`func (o *PatchedBulkWritableRearPortRequest) SetRelationships(v map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue)`
