...
// NestedDevice Base class to use for serializers based on OrganizationalModel or PrimaryModel.  Can also be used for models derived from BaseModel, so long as they support custom fields, notes, and relationships.
...
func (o *NestedDevice) GetObjectType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *NestedDevice) GetObjectTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NestedDevice) SetObjectType(v string) {
	o.ObjectType = v
}
