...
type ComputedField struct {
	...
	OutputType *ComputedFieldOutputType `json:"output_type,omitempty"`
...
func (o *ComputedField) GetOutputType() ComputedFieldOutputType {
	if o == nil || IsNil(o.OutputType) {
		var ret ComputedFieldOutputType
		return ret
	}
	return *o.OutputType
}
...
// SetOutputType gets a reference to the given ComputedFieldOutputType and assigns it to the OutputType field.
