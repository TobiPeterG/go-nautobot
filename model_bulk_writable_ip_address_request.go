...
// checks if the BulkWritableIPAddressRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkWritableIPAddressRequest{}
...
type _BulkWritableIPAddressRequest BulkWritableIPAddressRequest
...
func NewBulkWritableIPAddressRequest(id string, address string, status BulkWritableCableRequestStatus) *BulkWritableIPAddressRequest {
	this := BulkWritableIPAddressRequest{}
	this.Id = id
...
func (o *BulkWritableIPAddressRequest) SetRoleNil() {
	o.Role.Set(nil)
}
...
func (o *BulkWritableIPAddressRequest) SetParentNil() {
	o.Parent.Set(nil)
}
...
func (o *BulkWritableIPAddressRequest) SetTenantNil() {
	o.Tenant.Set(nil)
}
...
func (o *BulkWritableIPAddressRequest) SetNatInsideNil() {
	o.NatInside.Set(nil)
}
...
func (o BulkWritableIPAddressRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkWritableIPAddressRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkWritableIPAddressRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkWritableIPAddressRequest := _BulkWritableIPAddressRequest{}

	err = json.Unmarshal(data, &varBulkWritableIPAddressRequest)

	if err != nil {
		return err
	}

	*o = BulkWritableIPAddressRequest(varBulkWritableIPAddressRequest)
...
type NullableBulkWritableIPAddressRequest struct {
	value *BulkWritableIPAddressRequest
	isSet bool
}

func (v NullableBulkWritableIPAddressRequest) Get() *BulkWritableIPAddressRequest {
	return v.value
}

func (v *NullableBulkWritableIPAddressRequest) Set(val *BulkWritableIPAddressRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkWritableIPAddressRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkWritableIPAddressRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkWritableIPAddressRequest(val *BulkWritableIPAddressRequest) *NullableBulkWritableIPAddressRequest {
	return &NullableBulkWritableIPAddressRequest{value: val, isSet: true}
}

func (v NullableBulkWritableIPAddressRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkWritableIPAddressRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
