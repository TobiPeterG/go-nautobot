...
type PatchedRelationshipAssociationRequest struct {
	...
	Relationship *ApprovalWorkflowStageResponseApprovalWorkflowStage `json:"relationship,omitempty"`
...
func (o *PatchedRelationshipAssociationRequest) GetId() string {
	if o == nil || IsNil(o.Id) {
		var ret string
		return ret
	}
...
func (o *PatchedRelationshipAssociationRequest) GetIdOk() (*string, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *PatchedRelationshipAssociationRequest) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *PatchedRelationshipAssociationRequest) SetId(v string) {
	o.Id = &v
}
...
func (o *PatchedRelationshipAssociationRequest) GetRelationship() ApprovalWorkflowStageResponseApprovalWorkflowStage {
...
// and a boolean to check if the value has been set.
func (o *PatchedRelationshipAssociationRequest) GetRelationshipOk() (*ApprovalWorkflowStageResponseApprovalWorkflowStage, bool) {
	if o == nil || IsNil(o.Relationship) {
		return nil, false
	}
...
// SetRelationship gets a reference to the given ApprovalWorkflowStageResponseApprovalWorkflowStage and assigns it to the Relationship field.
func (o *PatchedRelationshipAssociationRequest) SetRelationship(v ApprovalWorkflowStageResponseApprovalWorkflowStage) {
	o.Relationship = &v
}
