...
func (o *ExportTemplateRequest) SetOwnerContentTypeNil() {
...
func (o *ExportTemplateRequest) SetOwnerObjectIdNil() {
...
func (o *ExportTemplateRequest) GetRelationships() map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue {
...
// and a boolean to check if the value has been set.
func (o *ExportTemplateRequest) GetRelationshipsOk() (*map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue, bool) {
	if o == nil || IsNil(o.Relationships) {
		return nil, false
	}
...
func (o *ExportTemplateRequest) SetRelationships(v map[string]ApprovalWorkflowDefinitionRequestRelationshipsValue) {
	o.Relationships = &v
}
