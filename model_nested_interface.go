...
// NestedInterface Base class to use for serializers based on OrganizationalModel or PrimaryModel.  Can also be used for models derived from BaseModel, so long as they support custom fields, notes, and relationships.
...
func (o *NestedInterface) GetObjectType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *NestedInterface) GetObjectTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NestedInterface) SetObjectType(v string) {
	o.ObjectType = v
}
