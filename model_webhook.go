...
func NewWebhook(objectType string, display string, url string, naturalSlug string, contentTypes []string, name string, payloadUrl string, created NullableTime, lastUpdated NullableTime, notesUrl string) *Webhook {
	this := Webhook{}
