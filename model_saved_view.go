...
func NewSavedView(objectType string, display string, url string, naturalSlug string, name string, view string, owner BulkWritableSavedViewRequestOwner, created NullableTime, lastUpdated NullableTime) *SavedView {
	this := SavedView{}
