...
// checks if the HealthCheckMonitorRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HealthCheckMonitorRequest{}

// HealthCheckMonitorRequest HealthCheckMonitor Serializer.
type HealthCheckMonitorRequest struct {
...
type _HealthCheckMonitorRequest HealthCheckMonitorRequest
...
func NewHealthCheckMonitorRequest(name string) *HealthCheckMonitorRequest {
	this := HealthCheckMonitorRequest{}
	this.Name = name
	return &this
}
...
func (o *HealthCheckMonitorRequest) SetIntervalNil() {
	o.Interval.Set(nil)
}
...
func (o *HealthCheckMonitorRequest) SetRetryNil() {
	o.Retry.Set(nil)
}
...
func (o *HealthCheckMonitorRequest) SetTimeoutNil() {
	o.Timeout.Set(nil)
}
...
func (o *HealthCheckMonitorRequest) SetPortNil() {
	o.Port.Set(nil)
}
...
func (o *HealthCheckMonitorRequest) SetTenantNil() {
	o.Tenant.Set(nil)
}
...
func (o *HealthCheckMonitorRequest) GetTags() []ApprovalWorkflowStageResponseApprovalWorkflowStage {
...
// and a boolean to check if the value has been set.
func (o *HealthCheckMonitorRequest) GetTagsOk() ([]ApprovalWorkflowStageResponseApprovalWorkflowStage, bool) {
	if o == nil || IsNil(o.Tags) {
		return nil, false
	}
	return o.Tags, true
...
func (o *HealthCheckMonitorRequest) SetTags(v []ApprovalWorkflowStageResponseApprovalWorkflowStage) {
	o.Tags = v
}

func (o HealthCheckMonitorRequest) MarshalJSON() ([]byte, error) {
...
func (o HealthCheckMonitorRequest) ToMap() (map[string]interface{}, error) {
...
func (o *HealthCheckMonitorRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varHealthCheckMonitorRequest := _HealthCheckMonitorRequest{}

	err = json.Unmarshal(data, &varHealthCheckMonitorRequest)

	if err != nil {
		return err
	}

	*o = HealthCheckMonitorRequest(varHealthCheckMonitorRequest)
...
type NullableHealthCheckMonitorRequest struct {
	value *HealthCheckMonitorRequest
	isSet bool
}

func (v NullableHealthCheckMonitorRequest) Get() *HealthCheckMonitorRequest {
	return v.value
}

func (v *NullableHealthCheckMonitorRequest) Set(val *HealthCheckMonitorRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableHealthCheckMonitorRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableHealthCheckMonitorRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHealthCheckMonitorRequest(val *HealthCheckMonitorRequest) *NullableHealthCheckMonitorRequest {
	return &NullableHealthCheckMonitorRequest{value: val, isSet: true}
}

func (v NullableHealthCheckMonitorRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHealthCheckMonitorRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
