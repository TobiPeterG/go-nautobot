...
type CablePath struct {
	...
	PeerConnector *int32 `json:"peer_connector,omitempty"`
	OriginFansOut *bool `json:"origin_fans_out,omitempty"`
	DestinationFansOut *bool `json:"destination_fans_out,omitempty"`
...
// GetPeerConnector returns the PeerConnector field value if set, zero value otherwise.
func (o *CablePath) GetPeerConnector() int32 {
	if o == nil || IsNil(o.PeerConnector) {
		var ret int32
		return ret
	}
	return *o.PeerConnector
}

// GetPeerConnectorOk returns a tuple with the PeerConnector field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CablePath) GetPeerConnectorOk() (*int32, bool) {
	if o == nil || IsNil(o.PeerConnector) {
		return nil, false
	}
	return o.PeerConnector, true
}
...
// SetPeerConnector gets a reference to the given int32 and assigns it to the PeerConnector field.
func (o *CablePath) SetPeerConnector(v int32) {
	o.PeerConnector = &v
}

// GetOriginFansOut returns the OriginFansOut field value if set, zero value otherwise.
func (o *CablePath) GetOriginFansOut() bool {
	if o == nil || IsNil(o.OriginFansOut) {
		var ret bool
		return ret
	}
	return *o.OriginFansOut
}

// GetOriginFansOutOk returns a tuple with the OriginFansOut field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CablePath) GetOriginFansOutOk() (*bool, bool) {
	if o == nil || IsNil(o.OriginFansOut) {
		return nil, false
	}
	return o.OriginFansOut, true
}
...
// SetOriginFansOut gets a reference to the given bool and assigns it to the OriginFansOut field.
func (o *CablePath) SetOriginFansOut(v bool) {
	o.OriginFansOut = &v
}

// GetDestinationFansOut returns the DestinationFansOut field value if set, zero value otherwise.
func (o *CablePath) GetDestinationFansOut() bool {
	if o == nil || IsNil(o.DestinationFansOut) {
		var ret bool
		return ret
	}
	return *o.DestinationFansOut
}

// GetDestinationFansOutOk returns a tuple with the DestinationFansOut field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CablePath) GetDestinationFansOutOk() (*bool, bool) {
	if o == nil || IsNil(o.DestinationFansOut) {
		return nil, false
	}
	return o.DestinationFansOut, true
}
...
// SetDestinationFansOut gets a reference to the given bool and assigns it to the DestinationFansOut field.
func (o *CablePath) SetDestinationFansOut(v bool) {
	o.DestinationFansOut = &v
}
...
func (o CablePath) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.PeerConnector) {
		toSerialize["peer_connector"] = o.PeerConnector
	}
	if !IsNil(o.OriginFansOut) {
		toSerialize["origin_fans_out"] = o.OriginFansOut
	}
	if !IsNil(o.DestinationFansOut) {
		toSerialize["destination_fans_out"] = o.DestinationFansOut
	}
...
func (o *CablePath) UnmarshalJSON(data []byte) (err error) {
	...
	*o = CablePath(varCablePath)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "peer_connector")
		delete(additionalProperties, "origin_fans_out")
		delete(additionalProperties, "destination_fans_out")
