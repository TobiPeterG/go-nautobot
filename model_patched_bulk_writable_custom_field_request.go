...
type PatchedBulkWritableCustomFieldRequest struct {
	...
	ScopeFilter interface{} `json:"scope_filter,omitempty"`
...
// GetScopeFilter returns the ScopeFilter field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *PatchedBulkWritableCustomFieldRequest) GetScopeFilter() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedBulkWritableCustomFieldRequest) GetScopeFilterOk() (*interface{}, bool) {
...
func (o *PatchedBulkWritableCustomFieldRequest) HasScopeFilter() bool {
	if o != nil && !IsNil(o.ScopeFilter) {
		return true
	}
...
// SetScopeFilter gets a reference to the given interface{} and assigns it to the ScopeFilter field.
func (o *PatchedBulkWritableCustomFieldRequest) SetScopeFilter(v interface{}) {
	o.ScopeFilter = v
}
...
func (o PatchedBulkWritableCustomFieldRequest) ToMap() (map[string]interface{}, error) {
	...
	if o.ScopeFilter != nil {
		toSerialize["scope_filter"] = o.ScopeFilter
	}
...
func (o *PatchedBulkWritableCustomFieldRequest) UnmarshalJSON(data []byte) (err error) {
	...
	*o = PatchedBulkWritableCustomFieldRequest(varPatchedBulkWritableCustomFieldRequest)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "scope_filter")
