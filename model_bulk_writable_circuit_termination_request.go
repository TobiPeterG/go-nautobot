...
type BulkWritableCircuitTerminationRequest struct {
	...
	ProviderNetwork NullableApprovalWorkflowUser `json:"provider_network,omitempty"`
	CloudNetwork NullableApprovalWorkflowUser `json:"cloud_network,omitempty"`
...
// SetProviderNetwork gets a reference to the given NullableApprovalWorkflowUser and assigns it to the ProviderNetwork field.
...
// SetCloudNetwork gets a reference to the given NullableApprovalWorkflowUser and assigns it to the CloudNetwork field.
