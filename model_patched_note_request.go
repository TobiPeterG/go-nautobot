...
// PatchedNoteRequest Extends the built-in ModelSerializer to enforce calling full_clean() on a copy of the associated instance during validation. (DRF does not do this by default; see https://github.com/encode/django-rest-framework/issues/3144)
...
func (o *PatchedNoteRequest) GetId() string {
	if o == nil || IsNil(o.Id) {
		var ret string
		return ret
	}
...
func (o *PatchedNoteRequest) GetIdOk() (*string, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *PatchedNoteRequest) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *PatchedNoteRequest) SetId(v string) {
	o.Id = &v
}
...
func (o *PatchedNoteRequest) GetUser() ApprovalWorkflowUser {
...
func (o *PatchedNoteRequest) GetUserOk() (*ApprovalWorkflowUser, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedNoteRequest) SetUser(v ApprovalWorkflowUser) {
	o.User.Set(&v)
}
