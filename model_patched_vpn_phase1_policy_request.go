...
// checks if the PatchedVPNPhase1PolicyRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedVPNPhase1PolicyRequest{}

// PatchedVPNPhase1PolicyRequest VPNPhase1Policy Serializer.
type PatchedVPNPhase1PolicyRequest struct {
...
type _PatchedVPNPhase1PolicyRequest PatchedVPNPhase1PolicyRequest
...
func NewPatchedVPNPhase1PolicyRequest() *PatchedVPNPhase1PolicyRequest {
	this := PatchedVPNPhase1PolicyRequest{}
	return &this
}
...
func (o *PatchedVPNPhase1PolicyRequest) SetLifetimeSecondsNil() {
...
func (o *PatchedVPNPhase1PolicyRequest) SetLifetimeKbNil() {
...
func (o *PatchedVPNPhase1PolicyRequest) SetTenantNil() {
	o.Tenant.Set(nil)
}
...
func (o PatchedVPNPhase1PolicyRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedVPNPhase1PolicyRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedVPNPhase1PolicyRequest) UnmarshalJSON(data []byte) (err error) {
	varPatchedVPNPhase1PolicyRequest := _PatchedVPNPhase1PolicyRequest{}

	err = json.Unmarshal(data, &varPatchedVPNPhase1PolicyRequest)

	if err != nil {
		return err
	}

	*o = PatchedVPNPhase1PolicyRequest(varPatchedVPNPhase1PolicyRequest)
...
type NullablePatchedVPNPhase1PolicyRequest struct {
	value *PatchedVPNPhase1PolicyRequest
	isSet bool
}

func (v NullablePatchedVPNPhase1PolicyRequest) Get() *PatchedVPNPhase1PolicyRequest {
	return v.value
}

func (v *NullablePatchedVPNPhase1PolicyRequest) Set(val *PatchedVPNPhase1PolicyRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedVPNPhase1PolicyRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedVPNPhase1PolicyRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedVPNPhase1PolicyRequest(val *PatchedVPNPhase1PolicyRequest) *NullablePatchedVPNPhase1PolicyRequest {
	return &NullablePatchedVPNPhase1PolicyRequest{value: val, isSet: true}
}

func (v NullablePatchedVPNPhase1PolicyRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedVPNPhase1PolicyRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
