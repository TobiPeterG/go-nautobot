...
type PatchedBulkWritableObjectMetadataRequest struct {
	...
	MetadataType *ApprovalWorkflowStageResponseApprovalWorkflowStage `json:"metadata_type,omitempty"`
...
// SetMetadataType gets a reference to the given ApprovalWorkflowStageResponseApprovalWorkflowStage and assigns it to the MetadataType field.
