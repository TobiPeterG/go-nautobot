...
// checks if the PatchedBulkWritableObjectMetadataRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedBulkWritableObjectMetadataRequest{}

// PatchedBulkWritableObjectMetadataRequest Extends the built-in ModelSerializer to enforce calling full_clean() on a copy of the associated instance during validation. (DRF does not do this by default; see https://github.com/encode/django-rest-framework/issues/3144)
type PatchedBulkWritableObjectMetadataRequest struct {
	Id string `json:"id"`
	AssignedObjectType *string `json:"assigned_object_type,omitempty"`
	Value interface{} `json:"value,omitempty"`
	// List of scoped fields, only direct fields on the model
	ScopedFields []string `json:"scoped_fields,omitempty"`
	...
	Contact NullableApprovalWorkflowUser `json:"contact,omitempty"`
	Team NullableApprovalWorkflowUser `json:"team,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _PatchedBulkWritableObjectMetadataRequest PatchedBulkWritableObjectMetadataRequest
...
func NewPatchedBulkWritableObjectMetadataRequest(id string) *PatchedBulkWritableObjectMetadataRequest {
	this := PatchedBulkWritableObjectMetadataRequest{}
	this.Id = id
	return &this
}
...
// GetScopedFields returns the ScopedFields field value if set, zero value otherwise.
...
// SetScopedFields gets a reference to the given []string and assigns it to the ScopedFields field.
...
// SetContact gets a reference to the given NullableApprovalWorkflowUser and assigns it to the Contact field.
func (o *PatchedBulkWritableObjectMetadataRequest) SetContact(v ApprovalWorkflowUser) {
	o.Contact.Set(&v)
}
// SetContactNil sets the value for Contact to be an explicit nil
func (o *PatchedBulkWritableObjectMetadataRequest) SetContactNil() {
	o.Contact.Set(nil)
}
...
// SetTeam gets a reference to the given NullableApprovalWorkflowUser and assigns it to the Team field.
func (o *PatchedBulkWritableObjectMetadataRequest) SetTeam(v ApprovalWorkflowUser) {
	o.Team.Set(&v)
}
// SetTeamNil sets the value for Team to be an explicit nil
func (o *PatchedBulkWritableObjectMetadataRequest) SetTeamNil() {
	o.Team.Set(nil)
}
...
func (o PatchedBulkWritableObjectMetadataRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedBulkWritableObjectMetadataRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedBulkWritableObjectMetadataRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchedBulkWritableObjectMetadataRequest := _PatchedBulkWritableObjectMetadataRequest{}

	err = json.Unmarshal(data, &varPatchedBulkWritableObjectMetadataRequest)

	if err != nil {
		return err
	}

	*o = PatchedBulkWritableObjectMetadataRequest(varPatchedBulkWritableObjectMetadataRequest)
...
type NullablePatchedBulkWritableObjectMetadataRequest struct {
	value *PatchedBulkWritableObjectMetadataRequest
	isSet bool
}

func (v NullablePatchedBulkWritableObjectMetadataRequest) Get() *PatchedBulkWritableObjectMetadataRequest {
	return v.value
}

func (v *NullablePatchedBulkWritableObjectMetadataRequest) Set(val *PatchedBulkWritableObjectMetadataRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedBulkWritableObjectMetadataRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedBulkWritableObjectMetadataRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedBulkWritableObjectMetadataRequest(val *PatchedBulkWritableObjectMetadataRequest) *NullablePatchedBulkWritableObjectMetadataRequest {
	return &NullablePatchedBulkWritableObjectMetadataRequest{value: val, isSet: true}
}

func (v NullablePatchedBulkWritableObjectMetadataRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedBulkWritableObjectMetadataRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
