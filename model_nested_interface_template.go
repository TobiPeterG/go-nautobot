...
// NestedInterfaceTemplate Base class to use for serializers based on OrganizationalModel or PrimaryModel.  Can also be used for models derived from BaseModel, so long as they support custom fields, notes, and relationships.
...
func (o *NestedInterfaceTemplate) GetId() string {
	if o == nil || IsNil(o.Id) {
		var ret string
		return ret
	}
...
func (o *NestedInterfaceTemplate) GetIdOk() (*string, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *NestedInterfaceTemplate) SetId(v string) {
	o.Id = &v
}

// GetObjectType returns the ObjectType field value
func (o *NestedInterfaceTemplate) GetObjectType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *NestedInterfaceTemplate) GetObjectTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NestedInterfaceTemplate) SetObjectType(v string) {
	o.ObjectType = v
}
