...
type PatchedWritableInterfaceRedundancyGroupRequest struct {
	...
	Protocol *RedundancyProtocol1 `json:"protocol,omitempty"`
...
// SetProtocol gets a reference to the given RedundancyProtocol1 and assigns it to the Protocol field.
