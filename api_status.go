...
// Serializer Depth
func (r ApiStatusRetrieveRequest) Depth(depth int32) ApiStatusRetrieveRequest {
	r.depth = &depth
	return r
}
...
//  @return StatusRetrieve200Response
func (a *StatusAPIService) StatusRetrieveExecute(r ApiStatusRetrieveRequest) (*StatusRetrieve200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *StatusRetrieve200Response
	)
