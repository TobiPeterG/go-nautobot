...
type WritableInterfaceRequest struct {
	...
	Mode *IEEE8021QMode1 `json:"mode,omitempty"`
...
// SetMode gets a reference to the given IEEE8021QMode1 and assigns it to the Mode field.
...
func (o *WritableInterfaceRequest) SetBreakoutPositionNil() {
