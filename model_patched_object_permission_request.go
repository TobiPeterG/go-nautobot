...
type PatchedObjectPermissionRequest struct {
	...
	Users []ApprovalWorkflowStageResponseApprovalWorkflowStage `json:"users,omitempty"`
...
// SetUsers gets a reference to the given []ApprovalWorkflowStageResponseApprovalWorkflowStage and assigns it to the Users field.
