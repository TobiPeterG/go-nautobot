...
func (o *VRFDeviceAssignment) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *VRFDeviceAssignment) HasVirtualDeviceContext() bool {
...
func (o *VRFDeviceAssignment) SetVirtualDeviceContextNil() {
...
func (o *VRFDeviceAssignment) UnsetVirtualDeviceContext() {
