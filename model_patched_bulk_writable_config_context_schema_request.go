...
// checks if the PatchedBulkWritableConfigContextSchemaRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedBulkWritableConfigContextSchemaRequest{}
...
type _PatchedBulkWritableConfigContextSchemaRequest PatchedBulkWritableConfigContextSchemaRequest
...
func NewPatchedBulkWritableConfigContextSchemaRequest(id string) *PatchedBulkWritableConfigContextSchemaRequest {
	this := PatchedBulkWritableConfigContextSchemaRequest{}
	this.Id = id
	return &this
}
...
func (o *PatchedBulkWritableConfigContextSchemaRequest) SetOwnerContentTypeNil() {
...
func (o *PatchedBulkWritableConfigContextSchemaRequest) SetOwnerObjectIdNil() {
...
func (o PatchedBulkWritableConfigContextSchemaRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedBulkWritableConfigContextSchemaRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedBulkWritableConfigContextSchemaRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchedBulkWritableConfigContextSchemaRequest := _PatchedBulkWritableConfigContextSchemaRequest{}

	err = json.Unmarshal(data, &varPatchedBulkWritableConfigContextSchemaRequest)

	if err != nil {
		return err
	}

	*o = PatchedBulkWritableConfigContextSchemaRequest(varPatchedBulkWritableConfigContextSchemaRequest)
...
type NullablePatchedBulkWritableConfigContextSchemaRequest struct {
	value *PatchedBulkWritableConfigContextSchemaRequest
	isSet bool
}

func (v NullablePatchedBulkWritableConfigContextSchemaRequest) Get() *PatchedBulkWritableConfigContextSchemaRequest {
	return v.value
}

func (v *NullablePatchedBulkWritableConfigContextSchemaRequest) Set(val *PatchedBulkWritableConfigContextSchemaRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedBulkWritableConfigContextSchemaRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedBulkWritableConfigContextSchemaRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedBulkWritableConfigContextSchemaRequest(val *PatchedBulkWritableConfigContextSchemaRequest) *NullablePatchedBulkWritableConfigContextSchemaRequest {
	return &NullablePatchedBulkWritableConfigContextSchemaRequest{value: val, isSet: true}
}

func (v NullablePatchedBulkWritableConfigContextSchemaRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedBulkWritableConfigContextSchemaRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
