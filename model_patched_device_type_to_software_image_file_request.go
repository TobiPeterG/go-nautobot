...
func (o *PatchedDeviceTypeToSoftwareImageFileRequest) GetId() string {
	if o == nil || IsNil(o.Id) {
		var ret string
		return ret
	}
...
func (o *PatchedDeviceTypeToSoftwareImageFileRequest) GetIdOk() (*string, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *PatchedDeviceTypeToSoftwareImageFileRequest) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *PatchedDeviceTypeToSoftwareImageFileRequest) SetId(v string) {
	o.Id = &v
}
