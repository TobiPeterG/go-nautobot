...
func (o *PatchedGraphQLQueryRequest) GetId() string {
	if o == nil || IsNil(o.Id) {
		var ret string
		return ret
	}
...
func (o *PatchedGraphQLQueryRequest) GetIdOk() (*string, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *PatchedGraphQLQueryRequest) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *PatchedGraphQLQueryRequest) SetId(v string) {
	o.Id = &v
}
...
func (o *PatchedGraphQLQueryRequest) GetOwnerContentType() string {
...
func (o *PatchedGraphQLQueryRequest) GetOwnerContentTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedGraphQLQueryRequest) HasOwnerContentType() bool {
...
func (o *PatchedGraphQLQueryRequest) SetOwnerContentType(v string) {
	o.OwnerContentType.Set(&v)
}
// SetOwnerContentTypeNil sets the value for OwnerContentType to be an explicit nil
func (o *PatchedGraphQLQueryRequest) SetOwnerContentTypeNil() {
...
func (o *PatchedGraphQLQueryRequest) UnsetOwnerContentType() {
...
func (o *PatchedGraphQLQueryRequest) GetOwnerObjectId() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedGraphQLQueryRequest) GetOwnerObjectIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PatchedGraphQLQueryRequest) HasOwnerObjectId() bool {
