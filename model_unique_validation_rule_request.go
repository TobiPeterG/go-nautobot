...
// checks if the UniqueValidationRuleRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UniqueValidationRuleRequest{}

// UniqueValidationRuleRequest Serializer for `UniqueValidationRule` objects.
type UniqueValidationRuleRequest struct {
...
type _UniqueValidationRuleRequest UniqueValidationRuleRequest
...
func NewUniqueValidationRuleRequest(contentType string, name string, field string) *UniqueValidationRuleRequest {
	this := UniqueValidationRuleRequest{}
...
func (o UniqueValidationRuleRequest) MarshalJSON() ([]byte, error) {
...
func (o UniqueValidationRuleRequest) ToMap() (map[string]interface{}, error) {
...
func (o *UniqueValidationRuleRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varUniqueValidationRuleRequest := _UniqueValidationRuleRequest{}

	err = json.Unmarshal(data, &varUniqueValidationRuleRequest)

	if err != nil {
		return err
	}

	*o = UniqueValidationRuleRequest(varUniqueValidationRuleRequest)
...
type NullableUniqueValidationRuleRequest struct {
	value *UniqueValidationRuleRequest
	isSet bool
}

func (v NullableUniqueValidationRuleRequest) Get() *UniqueValidationRuleRequest {
	return v.value
}

func (v *NullableUniqueValidationRuleRequest) Set(val *UniqueValidationRuleRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableUniqueValidationRuleRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableUniqueValidationRuleRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUniqueValidationRuleRequest(val *UniqueValidationRuleRequest) *NullableUniqueValidationRuleRequest {
	return &NullableUniqueValidationRuleRequest{value: val, isSet: true}
}

func (v NullableUniqueValidationRuleRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUniqueValidationRuleRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
