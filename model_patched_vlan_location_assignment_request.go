...
func (o *PatchedVLANLocationAssignmentRequest) GetId() string {
	if o == nil || IsNil(o.Id) {
		var ret string
		return ret
	}
...
func (o *PatchedVLANLocationAssignmentRequest) GetIdOk() (*string, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *PatchedVLANLocationAssignmentRequest) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *PatchedVLANLocationAssignmentRequest) SetId(v string) {
	o.Id = &v
}
