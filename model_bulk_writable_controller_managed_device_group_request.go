...
func (o *BulkWritableControllerManagedDeviceGroupRequest) SetTenantNil() {
	o.Tenant.Set(nil)
}
...
func (o *BulkWritableControllerManagedDeviceGroupRequest) GetTags() []ApprovalWorkflowStageResponseApprovalWorkflowStage {
...
// and a boolean to check if the value has been set.
func (o *BulkWritableControllerManagedDeviceGroupRequest) GetTagsOk() ([]ApprovalWorkflowStageResponseApprovalWorkflowStage, bool) {
	if o == nil || IsNil(o.Tags) {
		return nil, false
	}
	return o.Tags, true
...
func (o *BulkWritableControllerManagedDeviceGroupRequest) SetTags(v []ApprovalWorkflowStageResponseApprovalWorkflowStage) {
	o.Tags = v
}
