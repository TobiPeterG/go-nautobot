...
func (o *PatchedBulkWritableControllerManagedDeviceGroupRequest) SetTenantNil() {
	o.Tenant.Set(nil)
}
...
func (o *PatchedBulkWritableControllerManagedDeviceGroupRequest) GetTags() []ApprovalWorkflowStageResponseApprovalWorkflowStage {
...
// and a boolean to check if the value has been set.
func (o *PatchedBulkWritableControllerManagedDeviceGroupRequest) GetTagsOk() ([]ApprovalWorkflowStageResponseApprovalWorkflowStage, bool) {
	if o == nil || IsNil(o.Tags) {
		return nil, false
	}
	return o.Tags, true
...
func (o *PatchedBulkWritableControllerManagedDeviceGroupRequest) SetTags(v []ApprovalWorkflowStageResponseApprovalWorkflowStage) {
	o.Tags = v
}
