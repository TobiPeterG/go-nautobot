...
type InterfaceRedundancyGroup struct {
	...
	Protocol *InterfaceRedundancyGroupProtocol `json:"protocol,omitempty"`
...
// SetProtocol gets a reference to the given InterfaceRedundancyGroupProtocol and assigns it to the Protocol field.
