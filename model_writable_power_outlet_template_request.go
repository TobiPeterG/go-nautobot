...
// WritablePowerOutletTemplateRequest Base class to use for serializers based on OrganizationalModel or PrimaryModel.  Can also be used for models derived from BaseModel, so long as they support custom fields, notes, and relationships.
type WritablePowerOutletTemplateRequest struct {
	...
	PowerPortTemplate NullableApprovalWorkflowUser `json:"power_port_template,omitempty"`
...
// SetPowerPortTemplate gets a reference to the given NullableApprovalWorkflowUser and assigns it to the PowerPortTemplate field.
...
func (o *WritablePowerOutletTemplateRequest) SetPowerPortTemplateNil() {
