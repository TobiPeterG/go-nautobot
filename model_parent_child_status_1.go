...
// ParentChildStatus1 Parent devices house child devices in device bays. Leave blank if this device type is neither a parent nor a child.
...
const (
	...
	PARENTCHILDSTATUS1_PARENT_CHILD ParentChildStatus1 = "parent-child"
