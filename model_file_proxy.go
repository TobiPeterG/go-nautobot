...
type FileProxy struct {
	...
	JobResult NullableApprovalWorkflowUser `json:"job_result,omitempty"`
...
// SetJobResult gets a reference to the given NullableApprovalWorkflowUser and assigns it to the JobResult field.
