...
type UserRequest struct {
	...
	Groups []ApprovalWorkflowStageResponseApprovalWorkflowStage `json:"groups,omitempty"`
...
func (o *UserRequest) SetPasswordNil() {
	o.Password.Set(nil)
}
...
func (o *UserRequest) GetConfigData() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *UserRequest) GetConfigDataOk() (*interface{}, bool) {
...
func (o *UserRequest) SetConfigData(v interface{}) {
	o.ConfigData = v
}

// GetGroups returns the Groups field value if set, zero value otherwise.
func (o *UserRequest) GetGroups() []ApprovalWorkflowStageResponseApprovalWorkflowStage {
...
// and a boolean to check if the value has been set.
func (o *UserRequest) GetGroupsOk() ([]ApprovalWorkflowStageResponseApprovalWorkflowStage, bool) {
	if o == nil || IsNil(o.Groups) {
		return nil, false
	}
...
// SetGroups gets a reference to the given []ApprovalWorkflowStageResponseApprovalWorkflowStage and assigns it to the Groups field.
func (o *UserRequest) SetGroups(v []ApprovalWorkflowStageResponseApprovalWorkflowStage) {
	o.Groups = v
}
