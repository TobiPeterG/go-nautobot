...
type PatchedJobRequest struct {
	...
	DefaultJobQueue *BulkWritableCableRequestStatus `json:"default_job_queue,omitempty"`
...
// GetDefaultJobQueue returns the DefaultJobQueue field value if set, zero value otherwise.
func (o *PatchedJobRequest) GetDefaultJobQueue() BulkWritableCableRequestStatus {
	if o == nil || IsNil(o.DefaultJobQueue) {
...
// GetDefaultJobQueueOk returns a tuple with the DefaultJobQueue field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetDefaultJobQueue gets a reference to the given BulkWritableCableRequestStatus and assigns it to the DefaultJobQueue field.
