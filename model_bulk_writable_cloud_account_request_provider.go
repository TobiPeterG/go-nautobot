...
func (o *BulkWritableCloudAccountRequestProvider) GetId() ApprovalWorkflowApprovalWorkflowDefinitionId {
	if o == nil || IsNil(o.Id) {
...
func (o *BulkWritableCloudAccountRequestProvider) GetIdOk() (*ApprovalWorkflowApprovalWorkflowDefinitionId, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *BulkWritableCloudAccountRequestProvider) SetId(v ApprovalWorkflowApprovalWorkflowDefinitionId) {
	o.Id = &v
}
