...
// checks if the PaginatedAvailablePrefixList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedAvailablePrefixList{}
...
type PaginatedAvailablePrefixList struct {
	...
	Results []AvailablePrefix `json:"results"`
	AdditionalProperties map[string]interface{}
}

type _PaginatedAvailablePrefixList PaginatedAvailablePrefixList
...
func (o PaginatedAvailablePrefixList) ToMap() (map[string]interface{}, error) {
...
func (o *PaginatedAvailablePrefixList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedAvailablePrefixList := _PaginatedAvailablePrefixList{}

	err = json.Unmarshal(data, &varPaginatedAvailablePrefixList)

	if err != nil {
		return err
	}

	*o = PaginatedAvailablePrefixList(varPaginatedAvailablePrefixList)
