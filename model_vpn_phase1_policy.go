...
// checks if the VPNPhase1Policy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VPNPhase1Policy{}

// VPNPhase1Policy VPNPhase1Policy Serializer.
type VPNPhase1Policy struct {
...
type _VPNPhase1Policy VPNPhase1Policy
...
func (o *VPNPhase1Policy) SetLifetimeSecondsNil() {
...
func (o *VPNPhase1Policy) SetLifetimeKbNil() {
...
func (o *VPNPhase1Policy) SetTenantNil() {
	o.Tenant.Set(nil)
}
...
func (o *VPNPhase1Policy) GetTags() []ApprovalWorkflowStageResponseApprovalWorkflowStage {
...
// and a boolean to check if the value has been set.
func (o *VPNPhase1Policy) GetTagsOk() ([]ApprovalWorkflowStageResponseApprovalWorkflowStage, bool) {
	if o == nil || IsNil(o.Tags) {
		return nil, false
	}
	return o.Tags, true
...
func (o *VPNPhase1Policy) SetTags(v []ApprovalWorkflowStageResponseApprovalWorkflowStage) {
	o.Tags = v
}

func (o VPNPhase1Policy) MarshalJSON() ([]byte, error) {
...
func (o VPNPhase1Policy) ToMap() (map[string]interface{}, error) {
...
func (o *VPNPhase1Policy) UnmarshalJSON(data []byte) (err error) {
	...
	varVPNPhase1Policy := _VPNPhase1Policy{}

	err = json.Unmarshal(data, &varVPNPhase1Policy)

	if err != nil {
		return err
	}

	*o = VPNPhase1Policy(varVPNPhase1Policy)
...
type NullableVPNPhase1Policy struct {
	value *VPNPhase1Policy
	isSet bool
}

func (v NullableVPNPhase1Policy) Get() *VPNPhase1Policy {
	return v.value
}

func (v *NullableVPNPhase1Policy) Set(val *VPNPhase1Policy) {
	v.value = val
	v.isSet = true
}

func (v NullableVPNPhase1Policy) IsSet() bool {
	return v.isSet
}

func (v *NullableVPNPhase1Policy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVPNPhase1Policy(val *VPNPhase1Policy) *NullableVPNPhase1Policy {
	return &NullableVPNPhase1Policy{value: val, isSet: true}
}

func (v NullableVPNPhase1Policy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVPNPhase1Policy) UnmarshalJSON(src []byte) error {
	v.isSet = true
