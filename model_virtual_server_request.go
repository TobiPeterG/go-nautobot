...
// checks if the VirtualServerRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VirtualServerRequest{}

// VirtualServerRequest VirtualServer Serializer.
type VirtualServerRequest struct {
...
type _VirtualServerRequest VirtualServerRequest
...
func (o *VirtualServerRequest) SetPortNil() {
	o.Port.Set(nil)
}
...
func (o *VirtualServerRequest) SetSourceNatPoolNil() {
...
func (o *VirtualServerRequest) SetDeviceNil() {
	o.Device.Set(nil)
}
...
func (o *VirtualServerRequest) SetDeviceRedundancyGroupNil() {
...
func (o *VirtualServerRequest) SetCloudServiceNil() {
...
func (o *VirtualServerRequest) SetVirtualChassisNil() {
...
func (o *VirtualServerRequest) SetTenantNil() {
	o.Tenant.Set(nil)
}
...
func (o *VirtualServerRequest) SetLoadBalancerPoolNil() {
...
func (o *VirtualServerRequest) SetHealthCheckMonitorNil() {
...
func (o VirtualServerRequest) MarshalJSON() ([]byte, error) {
...
func (o VirtualServerRequest) ToMap() (map[string]interface{}, error) {
...
func (o *VirtualServerRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varVirtualServerRequest := _VirtualServerRequest{}

	err = json.Unmarshal(data, &varVirtualServerRequest)

	if err != nil {
		return err
	}

	*o = VirtualServerRequest(varVirtualServerRequest)
...
type NullableVirtualServerRequest struct {
	value *VirtualServerRequest
	isSet bool
}

func (v NullableVirtualServerRequest) Get() *VirtualServerRequest {
	return v.value
}

func (v *NullableVirtualServerRequest) Set(val *VirtualServerRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableVirtualServerRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableVirtualServerRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVirtualServerRequest(val *VirtualServerRequest) *NullableVirtualServerRequest {
	return &NullableVirtualServerRequest{value: val, isSet: true}
}

func (v NullableVirtualServerRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVirtualServerRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
