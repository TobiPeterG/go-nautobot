...
// checks if the PatchedBulkWritableWebhookRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedBulkWritableWebhookRequest{}
...
type _PatchedBulkWritableWebhookRequest PatchedBulkWritableWebhookRequest
...
func NewPatchedBulkWritableWebhookRequest(id string) *PatchedBulkWritableWebhookRequest {
	this := PatchedBulkWritableWebhookRequest{}
	this.Id = id
	return &this
}
...
func (o PatchedBulkWritableWebhookRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedBulkWritableWebhookRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedBulkWritableWebhookRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchedBulkWritableWebhookRequest := _PatchedBulkWritableWebhookRequest{}

	err = json.Unmarshal(data, &varPatchedBulkWritableWebhookRequest)

	if err != nil {
		return err
	}

	*o = PatchedBulkWritableWebhookRequest(varPatchedBulkWritableWebhookRequest)
...
type NullablePatchedBulkWritableWebhookRequest struct {
	value *PatchedBulkWritableWebhookRequest
	isSet bool
}

func (v NullablePatchedBulkWritableWebhookRequest) Get() *PatchedBulkWritableWebhookRequest {
	return v.value
}

func (v *NullablePatchedBulkWritableWebhookRequest) Set(val *PatchedBulkWritableWebhookRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedBulkWritableWebhookRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedBulkWritableWebhookRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedBulkWritableWebhookRequest(val *PatchedBulkWritableWebhookRequest) *NullablePatchedBulkWritableWebhookRequest {
	return &NullablePatchedBulkWritableWebhookRequest{value: val, isSet: true}
}

func (v NullablePatchedBulkWritableWebhookRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedBulkWritableWebhookRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
