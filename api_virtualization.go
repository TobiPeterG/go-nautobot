...
func (r ApiVirtualizationInterfacesListRequest) Mode(mode []IEEE8021QMode) ApiVirtualizationInterfacesListRequest {
	r.mode = &mode
	return r
}
...
func (r ApiVirtualizationVirtualMachinesListRequest) Vrfs(vrfs []string) ApiVirtualizationVirtualMachinesListRequest {
	r.vrfs = &vrfs
	return r
}

// VRFs (ID or RD) is null
func (r ApiVirtualizationVirtualMachinesListRequest) VrfsIsnull(vrfsIsnull bool) ApiVirtualizationVirtualMachinesListRequest {
	r.vrfsIsnull = &vrfsIsnull
	return r
}

func (r ApiVirtualizationVirtualMachinesListRequest) VrfsN(vrfsN []string) ApiVirtualizationVirtualMachinesListRequest {
	r.vrfsN = &vrfsN
	return r
}
