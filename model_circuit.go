...
type Circuit struct {
	...
	CircuitTerminationA NullableCircuitCircuitTerminationA `json:"circuit_termination_a"`
	CircuitTerminationZ NullableCircuitCircuitTerminationA `json:"circuit_termination_z"`
...
func NewCircuit(objectType string, display string, url string, naturalSlug string, cid string, status BulkWritableCableRequestStatus, provider BulkWritableCableRequestStatus, circuitType BulkWritableCableRequestStatus, circuitTerminationA NullableCircuitCircuitTerminationA, circuitTerminationZ NullableCircuitCircuitTerminationA, created NullableTime, lastUpdated NullableTime, notesUrl string) *Circuit {
	...
	this.CircuitTerminationA = circuitTerminationA
	this.CircuitTerminationZ = circuitTerminationZ
...
// GetCircuitTerminationA returns the CircuitTerminationA field value
...
func (o *Circuit) GetCircuitTerminationA() CircuitCircuitTerminationA {
	if o == nil || o.CircuitTerminationA.Get() == nil {
		var ret CircuitCircuitTerminationA
		return ret
	}

	return *o.CircuitTerminationA.Get()
}

// GetCircuitTerminationAOk returns a tuple with the CircuitTerminationA field value
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Circuit) GetCircuitTerminationAOk() (*CircuitCircuitTerminationA, bool) {
	...
	return o.CircuitTerminationA.Get(), o.CircuitTerminationA.IsSet()
}

// SetCircuitTerminationA sets field value
func (o *Circuit) SetCircuitTerminationA(v CircuitCircuitTerminationA) {
	o.CircuitTerminationA.Set(&v)
}

// GetCircuitTerminationZ returns the CircuitTerminationZ field value
// If the value is explicit nil, the zero value for CircuitCircuitTerminationA will be returned
func (o *Circuit) GetCircuitTerminationZ() CircuitCircuitTerminationA {
	if o == nil || o.CircuitTerminationZ.Get() == nil {
		var ret CircuitCircuitTerminationA
		return ret
	}

	return *o.CircuitTerminationZ.Get()
}

// GetCircuitTerminationZOk returns a tuple with the CircuitTerminationZ field value
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *Circuit) GetCircuitTerminationZOk() (*CircuitCircuitTerminationA, bool) {
	...
	return o.CircuitTerminationZ.Get(), o.CircuitTerminationZ.IsSet()
}

// SetCircuitTerminationZ sets field value
func (o *Circuit) SetCircuitTerminationZ(v CircuitCircuitTerminationA) {
	o.CircuitTerminationZ.Set(&v)
}
...
func (o Circuit) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["circuit_termination_a"] = o.CircuitTerminationA.Get()
	toSerialize["circuit_termination_z"] = o.CircuitTerminationZ.Get()
...
func (o *Circuit) UnmarshalJSON(data []byte) (err error) {
	...
	*o = Circuit(varCircuit)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "circuit_termination_a")
		delete(additionalProperties, "circuit_termination_z")
