...
func (o *BulkWritableCustomFieldRequest) GetScopeFilter() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *BulkWritableCustomFieldRequest) GetScopeFilterOk() (*interface{}, bool) {
...
func (o *BulkWritableCustomFieldRequest) HasScopeFilter() bool {
	if o != nil && !IsNil(o.ScopeFilter) {
		return true
	}
...
func (o *BulkWritableCustomFieldRequest) SetScopeFilter(v interface{}) {
	o.ScopeFilter = v
}
