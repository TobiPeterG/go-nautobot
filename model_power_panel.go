...
type PowerPanel struct {
	...
	PanelType *PowerPanelPanelType `json:"panel_type,omitempty"`
...
// SetPanelType gets a reference to the given PowerPanelPanelType and assigns it to the PanelType field.
...
func (o *PowerPanel) SetBreakerPositionCountNil() {
