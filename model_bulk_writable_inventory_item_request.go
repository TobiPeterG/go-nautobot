...
func NewBulkWritableInventoryItemRequest(id string, name string, device ApprovalWorkflowStageResponseApprovalWorkflowStage) *BulkWritableInventoryItemRequest {
...
func (o *BulkWritableInventoryItemRequest) GetDevice() ApprovalWorkflowStageResponseApprovalWorkflowStage {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *BulkWritableInventoryItemRequest) GetDeviceOk() (*ApprovalWorkflowStageResponseApprovalWorkflowStage, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkWritableInventoryItemRequest) SetDevice(v ApprovalWorkflowStageResponseApprovalWorkflowStage) {
	o.Device = v
}
...
func (o *BulkWritableInventoryItemRequest) GetTags() []ApprovalWorkflowStageResponseApprovalWorkflowStage {
...
// and a boolean to check if the value has been set.
func (o *BulkWritableInventoryItemRequest) GetTagsOk() ([]ApprovalWorkflowStageResponseApprovalWorkflowStage, bool) {
	if o == nil || IsNil(o.Tags) {
		return nil, false
	}
	return o.Tags, true
...
func (o *BulkWritableInventoryItemRequest) SetTags(v []ApprovalWorkflowStageResponseApprovalWorkflowStage) {
	o.Tags = v
}
