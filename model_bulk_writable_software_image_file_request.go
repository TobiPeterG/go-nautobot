...
// checks if the BulkWritableSoftwareImageFileRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkWritableSoftwareImageFileRequest{}
...
type BulkWritableSoftwareImageFileRequest struct {
	...
	SoftwareVersion ApprovalWorkflowStageResponseApprovalWorkflowStage `json:"software_version"`
...
type _BulkWritableSoftwareImageFileRequest BulkWritableSoftwareImageFileRequest
...
func NewBulkWritableSoftwareImageFileRequest(id string, imageFileName string, softwareVersion ApprovalWorkflowStageResponseApprovalWorkflowStage, status ApprovalWorkflowStageResponseApprovalWorkflowStage) *BulkWritableSoftwareImageFileRequest {
	this := BulkWritableSoftwareImageFileRequest{}
	this.Id = id
...
func (o *BulkWritableSoftwareImageFileRequest) SetImageFileSizeNil() {
...
func (o *BulkWritableSoftwareImageFileRequest) GetSoftwareVersion() ApprovalWorkflowStageResponseApprovalWorkflowStage {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *BulkWritableSoftwareImageFileRequest) GetSoftwareVersionOk() (*ApprovalWorkflowStageResponseApprovalWorkflowStage, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkWritableSoftwareImageFileRequest) SetSoftwareVersion(v ApprovalWorkflowStageResponseApprovalWorkflowStage) {
	o.SoftwareVersion = v
}
...
func (o *BulkWritableSoftwareImageFileRequest) SetExternalIntegrationNil() {
...
func (o *BulkWritableSoftwareImageFileRequest) GetStatus() ApprovalWorkflowStageResponseApprovalWorkflowStage {
	if o == nil {
		var ret ApprovalWorkflowStageResponseApprovalWorkflowStage
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *BulkWritableSoftwareImageFileRequest) GetStatusOk() (*ApprovalWorkflowStageResponseApprovalWorkflowStage, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkWritableSoftwareImageFileRequest) SetStatus(v ApprovalWorkflowStageResponseApprovalWorkflowStage) {
	o.Status = v
}
...
func (o *BulkWritableSoftwareImageFileRequest) GetTags() []ApprovalWorkflowStageResponseApprovalWorkflowStage {
...
// and a boolean to check if the value has been set.
func (o *BulkWritableSoftwareImageFileRequest) GetTagsOk() ([]ApprovalWorkflowStageResponseApprovalWorkflowStage, bool) {
	if o == nil || IsNil(o.Tags) {
		return nil, false
	}
	return o.Tags, true
...
func (o *BulkWritableSoftwareImageFileRequest) SetTags(v []ApprovalWorkflowStageResponseApprovalWorkflowStage) {
	o.Tags = v
}

func (o BulkWritableSoftwareImageFileRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkWritableSoftwareImageFileRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkWritableSoftwareImageFileRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkWritableSoftwareImageFileRequest := _BulkWritableSoftwareImageFileRequest{}

	err = json.Unmarshal(data, &varBulkWritableSoftwareImageFileRequest)

	if err != nil {
		return err
	}

	*o = BulkWritableSoftwareImageFileRequest(varBulkWritableSoftwareImageFileRequest)
...
type NullableBulkWritableSoftwareImageFileRequest struct {
	value *BulkWritableSoftwareImageFileRequest
	isSet bool
}

func (v NullableBulkWritableSoftwareImageFileRequest) Get() *BulkWritableSoftwareImageFileRequest {
	return v.value
}

func (v *NullableBulkWritableSoftwareImageFileRequest) Set(val *BulkWritableSoftwareImageFileRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkWritableSoftwareImageFileRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkWritableSoftwareImageFileRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkWritableSoftwareImageFileRequest(val *BulkWritableSoftwareImageFileRequest) *NullableBulkWritableSoftwareImageFileRequest {
	return &NullableBulkWritableSoftwareImageFileRequest{value: val, isSet: true}
}

func (v NullableBulkWritableSoftwareImageFileRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkWritableSoftwareImageFileRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
