...
type PowerFeed struct {
	...
	PowerPath *PowerFeedPowerPath `json:"power_path,omitempty"`
	Supply *PowerFeedSupply `json:"supply,omitempty"`
	Phase *PowerFeedPhase `json:"phase,omitempty"`
	BreakerPoleCount NullablePowerFeedBreakerPoleCount `json:"breaker_pole_count,omitempty"`
...
// SetPowerPath gets a reference to the given PowerFeedPowerPath and assigns it to the PowerPath field.
...
func (o *PowerFeed) GetBreakerPoleCount() PowerFeedBreakerPoleCount {
	if o == nil || IsNil(o.BreakerPoleCount.Get()) {
		var ret PowerFeedBreakerPoleCount
		return ret
	}
...
// SetBreakerPoleCount gets a reference to the given NullablePowerFeedBreakerPoleCount and assigns it to the BreakerPoleCount field.
...
func (o *PowerFeed) SetBreakerPoleCountNil() {
...
func (o *PowerFeed) SetBreakerPositionNil() {
...
func (o *PowerFeed) SetDestinationPanelNil() {
