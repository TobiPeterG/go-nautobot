...
type PatchedVirtualServerRequest struct {
	...
	Vip *BulkWritableCableRequestStatus `json:"vip,omitempty"`
...
// SetVip gets a reference to the given BulkWritableCableRequestStatus and assigns it to the Vip field.
