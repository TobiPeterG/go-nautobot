...
type PatchedBulkWritableSecretsGroupAssociationRequest struct {
	...
	SecretsGroup *ApprovalWorkflowStageResponseApprovalWorkflowStage `json:"secrets_group,omitempty"`
	Secret *ApprovalWorkflowStageResponseApprovalWorkflowStage `json:"secret,omitempty"`
...
// SetSecretsGroup gets a reference to the given ApprovalWorkflowStageResponseApprovalWorkflowStage and assigns it to the SecretsGroup field.
...
// SetSecret gets a reference to the given ApprovalWorkflowStageResponseApprovalWorkflowStage and assigns it to the Secret field.
