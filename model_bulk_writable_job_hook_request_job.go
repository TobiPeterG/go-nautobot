...
func (o *BulkWritableJobHookRequestJob) GetId() ApprovalWorkflowApprovalWorkflowDefinitionId {
	if o == nil || IsNil(o.Id) {
...
func (o *BulkWritableJobHookRequestJob) GetIdOk() (*ApprovalWorkflowApprovalWorkflowDefinitionId, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *BulkWritableJobHookRequestJob) SetId(v ApprovalWorkflowApprovalWorkflowDefinitionId) {
	o.Id = &v
}
