...
type PatchedDynamicGroupMembershipRequest struct {
	...
	Group *ApprovalWorkflowStageResponseApprovalWorkflowStage `json:"group,omitempty"`
	ParentGroup *ApprovalWorkflowStageResponseApprovalWorkflowStage `json:"parent_group,omitempty"`
...
func (o *PatchedDynamicGroupMembershipRequest) GetId() string {
	if o == nil || IsNil(o.Id) {
		var ret string
		return ret
	}
...
func (o *PatchedDynamicGroupMembershipRequest) GetIdOk() (*string, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *PatchedDynamicGroupMembershipRequest) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *PatchedDynamicGroupMembershipRequest) SetId(v string) {
	o.Id = &v
}
...
func (o *PatchedDynamicGroupMembershipRequest) GetGroup() ApprovalWorkflowStageResponseApprovalWorkflowStage {
...
// and a boolean to check if the value has been set.
func (o *PatchedDynamicGroupMembershipRequest) GetGroupOk() (*ApprovalWorkflowStageResponseApprovalWorkflowStage, bool) {
	if o == nil || IsNil(o.Group) {
		return nil, false
	}
	return o.Group, true
...
// SetGroup gets a reference to the given ApprovalWorkflowStageResponseApprovalWorkflowStage and assigns it to the Group field.
func (o *PatchedDynamicGroupMembershipRequest) SetGroup(v ApprovalWorkflowStageResponseApprovalWorkflowStage) {
	o.Group = &v
}

// GetParentGroup returns the ParentGroup field value if set, zero value otherwise.
func (o *PatchedDynamicGroupMembershipRequest) GetParentGroup() ApprovalWorkflowStageResponseApprovalWorkflowStage {
...
// and a boolean to check if the value has been set.
func (o *PatchedDynamicGroupMembershipRequest) GetParentGroupOk() (*ApprovalWorkflowStageResponseApprovalWorkflowStage, bool) {
	if o == nil || IsNil(o.ParentGroup) {
		return nil, false
	}
...
// SetParentGroup gets a reference to the given ApprovalWorkflowStageResponseApprovalWorkflowStage and assigns it to the ParentGroup field.
func (o *PatchedDynamicGroupMembershipRequest) SetParentGroup(v ApprovalWorkflowStageResponseApprovalWorkflowStage) {
	o.ParentGroup = &v
}
