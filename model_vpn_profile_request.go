...
// checks if the VPNProfileRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VPNProfileRequest{}

// VPNProfileRequest VPNProfile Serializer.
...
type _VPNProfileRequest VPNProfileRequest
...
func (o *VPNProfileRequest) SetKeepaliveIntervalNil() {
...
func (o *VPNProfileRequest) SetKeepaliveRetriesNil() {
...
func (o *VPNProfileRequest) SetRoleNil() {
	o.Role.Set(nil)
}
...
func (o *VPNProfileRequest) SetSecretsGroupNil() {
...
func (o *VPNProfileRequest) SetTenantNil() {
	o.Tenant.Set(nil)
}
...
func (o *VPNProfileRequest) GetTags() []ApprovalWorkflowStageResponseApprovalWorkflowStage {
...
// and a boolean to check if the value has been set.
func (o *VPNProfileRequest) GetTagsOk() ([]ApprovalWorkflowStageResponseApprovalWorkflowStage, bool) {
	if o == nil || IsNil(o.Tags) {
		return nil, false
	}
	return o.Tags, true
...
func (o *VPNProfileRequest) SetTags(v []ApprovalWorkflowStageResponseApprovalWorkflowStage) {
	o.Tags = v
}

func (o VPNProfileRequest) MarshalJSON() ([]byte, error) {
...
func (o VPNProfileRequest) ToMap() (map[string]interface{}, error) {
...
func (o *VPNProfileRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varVPNProfileRequest := _VPNProfileRequest{}

	err = json.Unmarshal(data, &varVPNProfileRequest)

	if err != nil {
		return err
	}

	*o = VPNProfileRequest(varVPNProfileRequest)
...
type NullableVPNProfileRequest struct {
	value *VPNProfileRequest
	isSet bool
}

func (v NullableVPNProfileRequest) Get() *VPNProfileRequest {
	return v.value
}

func (v *NullableVPNProfileRequest) Set(val *VPNProfileRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableVPNProfileRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableVPNProfileRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVPNProfileRequest(val *VPNProfileRequest) *NullableVPNProfileRequest {
	return &NullableVPNProfileRequest{value: val, isSet: true}
}

func (v NullableVPNProfileRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVPNProfileRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
