...
type Interface struct {
	...
	PortType *FrontPortType `json:"port_type,omitempty"`
...
// SetPortType gets a reference to the given FrontPortType and assigns it to the PortType field.
...
// SetDuplex gets a reference to the given InterfaceDuplex and assigns it to the Duplex field.
...
func (o *Interface) SetBreakoutPositionNil() {
