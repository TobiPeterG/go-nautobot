...
// checks if the PatchedBulkWritableFrontPortRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedBulkWritableFrontPortRequest{}

// PatchedBulkWritableFrontPortRequest Base class to use for serializers based on OrganizationalModel or PrimaryModel.  Can also be used for models derived from BaseModel, so long as they support custom fields, notes, and relationships.
type PatchedBulkWritableFrontPortRequest struct {
	...
	RearPort *ApprovalWorkflowStageResponseApprovalWorkflowStage `json:"rear_port,omitempty"`
...
type _PatchedBulkWritableFrontPortRequest PatchedBulkWritableFrontPortRequest
...
func NewPatchedBulkWritableFrontPortRequest(id string) *PatchedBulkWritableFrontPortRequest {
	this := PatchedBulkWritableFrontPortRequest{}
	this.Id = id
	return &this
}
...
func (o *PatchedBulkWritableFrontPortRequest) SetDeviceNil() {
	o.Device.Set(nil)
}
...
func (o *PatchedBulkWritableFrontPortRequest) SetModuleNil() {
	o.Module.Set(nil)
}
...
func (o *PatchedBulkWritableFrontPortRequest) GetRearPort() ApprovalWorkflowStageResponseApprovalWorkflowStage {
...
// and a boolean to check if the value has been set.
func (o *PatchedBulkWritableFrontPortRequest) GetRearPortOk() (*ApprovalWorkflowStageResponseApprovalWorkflowStage, bool) {
	if o == nil || IsNil(o.RearPort) {
		return nil, false
	}
...
// SetRearPort gets a reference to the given ApprovalWorkflowStageResponseApprovalWorkflowStage and assigns it to the RearPort field.
func (o *PatchedBulkWritableFrontPortRequest) SetRearPort(v ApprovalWorkflowStageResponseApprovalWorkflowStage) {
	o.RearPort = &v
}
...
func (o *PatchedBulkWritableFrontPortRequest) GetTags() []ApprovalWorkflowStageResponseApprovalWorkflowStage {
...
// and a boolean to check if the value has been set.
func (o *PatchedBulkWritableFrontPortRequest) GetTagsOk() ([]ApprovalWorkflowStageResponseApprovalWorkflowStage, bool) {
	if o == nil || IsNil(o.Tags) {
		return nil, false
	}
	return o.Tags, true
...
func (o *PatchedBulkWritableFrontPortRequest) SetTags(v []ApprovalWorkflowStageResponseApprovalWorkflowStage) {
	o.Tags = v
}

func (o PatchedBulkWritableFrontPortRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedBulkWritableFrontPortRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedBulkWritableFrontPortRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchedBulkWritableFrontPortRequest := _PatchedBulkWritableFrontPortRequest{}

	err = json.Unmarshal(data, &varPatchedBulkWritableFrontPortRequest)

	if err != nil {
		return err
	}

	*o = PatchedBulkWritableFrontPortRequest(varPatchedBulkWritableFrontPortRequest)
...
type NullablePatchedBulkWritableFrontPortRequest struct {
	value *PatchedBulkWritableFrontPortRequest
	isSet bool
}

func (v NullablePatchedBulkWritableFrontPortRequest) Get() *PatchedBulkWritableFrontPortRequest {
	return v.value
}

func (v *NullablePatchedBulkWritableFrontPortRequest) Set(val *PatchedBulkWritableFrontPortRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedBulkWritableFrontPortRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedBulkWritableFrontPortRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedBulkWritableFrontPortRequest(val *PatchedBulkWritableFrontPortRequest) *NullablePatchedBulkWritableFrontPortRequest {
	return &NullablePatchedBulkWritableFrontPortRequest{value: val, isSet: true}
}

func (v NullablePatchedBulkWritableFrontPortRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedBulkWritableFrontPortRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
