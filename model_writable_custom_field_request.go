...
func (o *WritableCustomFieldRequest) GetScopeFilter() interface{} {
	if o == nil {
		var ret interface{}
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WritableCustomFieldRequest) GetScopeFilterOk() (*interface{}, bool) {
...
func (o *WritableCustomFieldRequest) HasScopeFilter() bool {
	if o != nil && !IsNil(o.ScopeFilter) {
		return true
	}
...
func (o *WritableCustomFieldRequest) SetScopeFilter(v interface{}) {
	o.ScopeFilter = v
}
