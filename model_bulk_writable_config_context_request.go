...
// checks if the BulkWritableConfigContextRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkWritableConfigContextRequest{}
...
type _BulkWritableConfigContextRequest BulkWritableConfigContextRequest
...
func NewBulkWritableConfigContextRequest(id string, name string, data interface{}) *BulkWritableConfigContextRequest {
	this := BulkWritableConfigContextRequest{}
	this.Id = id
	this.Name = name
	this.Data = data
	return &this
...
func (o *BulkWritableConfigContextRequest) SetOwnerContentTypeNil() {
...
func (o *BulkWritableConfigContextRequest) SetOwnerObjectIdNil() {
...
func (o *BulkWritableConfigContextRequest) SetConfigContextSchemaNil() {
...
func (o BulkWritableConfigContextRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkWritableConfigContextRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkWritableConfigContextRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkWritableConfigContextRequest := _BulkWritableConfigContextRequest{}

	err = json.Unmarshal(data, &varBulkWritableConfigContextRequest)

	if err != nil {
		return err
	}

	*o = BulkWritableConfigContextRequest(varBulkWritableConfigContextRequest)
...
type NullableBulkWritableConfigContextRequest struct {
	value *BulkWritableConfigContextRequest
	isSet bool
}

func (v NullableBulkWritableConfigContextRequest) Get() *BulkWritableConfigContextRequest {
	return v.value
}

func (v *NullableBulkWritableConfigContextRequest) Set(val *BulkWritableConfigContextRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkWritableConfigContextRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkWritableConfigContextRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkWritableConfigContextRequest(val *BulkWritableConfigContextRequest) *NullableBulkWritableConfigContextRequest {
	return &NullableBulkWritableConfigContextRequest{value: val, isSet: true}
}

func (v NullableBulkWritableConfigContextRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkWritableConfigContextRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
