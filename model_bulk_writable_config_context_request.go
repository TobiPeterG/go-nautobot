...
type BulkWritableConfigContextRequest struct {
	...
	DeviceFamilies []BulkWritableCableRequestStatus `json:"device_families,omitempty"`
...
func (o *BulkWritableConfigContextRequest) GetDeviceFamilies() []BulkWritableCableRequestStatus {
...
// and a boolean to check if the value has been set.
func (o *BulkWritableConfigContextRequest) GetDeviceFamiliesOk() ([]BulkWritableCableRequestStatus, bool) {
	if o == nil || IsNil(o.DeviceFamilies) {
		return nil, false
	}
...
// SetDeviceFamilies gets a reference to the given []BulkWritableCableRequestStatus and assigns it to the DeviceFamilies field.
func (o *BulkWritableConfigContextRequest) SetDeviceFamilies(v []BulkWritableCableRequestStatus) {
	o.DeviceFamilies = v
}
