...
// checks if the PatchedBulkWritableDeviceBayRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchedBulkWritableDeviceBayRequest{}

// PatchedBulkWritableDeviceBayRequest Base class to use for serializers based on OrganizationalModel or PrimaryModel.  Can also be used for models derived from BaseModel, so long as they support custom fields, notes, and relationships.
type PatchedBulkWritableDeviceBayRequest struct {
	...
	InstalledDevice NullableApprovalWorkflowUser `json:"installed_device,omitempty"`
...
type _PatchedBulkWritableDeviceBayRequest PatchedBulkWritableDeviceBayRequest
...
func NewPatchedBulkWritableDeviceBayRequest(id string) *PatchedBulkWritableDeviceBayRequest {
	this := PatchedBulkWritableDeviceBayRequest{}
	this.Id = id
	return &this
}
...
// SetInstalledDevice gets a reference to the given NullableApprovalWorkflowUser and assigns it to the InstalledDevice field.
...
func (o *PatchedBulkWritableDeviceBayRequest) SetInstalledDeviceNil() {
...
func (o PatchedBulkWritableDeviceBayRequest) MarshalJSON() ([]byte, error) {
...
func (o PatchedBulkWritableDeviceBayRequest) ToMap() (map[string]interface{}, error) {
...
func (o *PatchedBulkWritableDeviceBayRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varPatchedBulkWritableDeviceBayRequest := _PatchedBulkWritableDeviceBayRequest{}

	err = json.Unmarshal(data, &varPatchedBulkWritableDeviceBayRequest)

	if err != nil {
		return err
	}

	*o = PatchedBulkWritableDeviceBayRequest(varPatchedBulkWritableDeviceBayRequest)
...
type NullablePatchedBulkWritableDeviceBayRequest struct {
	value *PatchedBulkWritableDeviceBayRequest
	isSet bool
}

func (v NullablePatchedBulkWritableDeviceBayRequest) Get() *PatchedBulkWritableDeviceBayRequest {
	return v.value
}

func (v *NullablePatchedBulkWritableDeviceBayRequest) Set(val *PatchedBulkWritableDeviceBayRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePatchedBulkWritableDeviceBayRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePatchedBulkWritableDeviceBayRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePatchedBulkWritableDeviceBayRequest(val *PatchedBulkWritableDeviceBayRequest) *NullablePatchedBulkWritableDeviceBayRequest {
	return &NullablePatchedBulkWritableDeviceBayRequest{value: val, isSet: true}
}

func (v NullablePatchedBulkWritableDeviceBayRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePatchedBulkWritableDeviceBayRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
