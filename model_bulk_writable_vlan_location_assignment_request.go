...
func NewBulkWritableVLANLocationAssignmentRequest(id string, vlan ApprovalWorkflowStageResponseApprovalWorkflowStage, location ApprovalWorkflowStageResponseApprovalWorkflowStage) *BulkWritableVLANLocationAssignmentRequest {
...
func (o *BulkWritableVLANLocationAssignmentRequest) GetVlan() ApprovalWorkflowStageResponseApprovalWorkflowStage {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *BulkWritableVLANLocationAssignmentRequest) GetVlanOk() (*ApprovalWorkflowStageResponseApprovalWorkflowStage, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Vlan, true
...
func (o *BulkWritableVLANLocationAssignmentRequest) SetVlan(v ApprovalWorkflowStageResponseApprovalWorkflowStage) {
	o.Vlan = v
}

// GetLocation returns the Location field value
func (o *BulkWritableVLANLocationAssignmentRequest) GetLocation() ApprovalWorkflowStageResponseApprovalWorkflowStage {
	if o == nil {
		var ret ApprovalWorkflowStageResponseApprovalWorkflowStage
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *BulkWritableVLANLocationAssignmentRequest) GetLocationOk() (*ApprovalWorkflowStageResponseApprovalWorkflowStage, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *BulkWritableVLANLocationAssignmentRequest) SetLocation(v ApprovalWorkflowStageResponseApprovalWorkflowStage) {
	o.Location = v
}
