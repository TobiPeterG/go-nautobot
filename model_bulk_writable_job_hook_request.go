...
// checks if the BulkWritableJobHookRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkWritableJobHookRequest{}
...
type _BulkWritableJobHookRequest BulkWritableJobHookRequest
...
func NewBulkWritableJobHookRequest(id string, contentTypes []string, name string, job BulkWritableJobHookRequestJob) *BulkWritableJobHookRequest {
	this := BulkWritableJobHookRequest{}
	this.Id = id
...
func (o BulkWritableJobHookRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkWritableJobHookRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkWritableJobHookRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkWritableJobHookRequest := _BulkWritableJobHookRequest{}

	err = json.Unmarshal(data, &varBulkWritableJobHookRequest)

	if err != nil {
		return err
	}

	*o = BulkWritableJobHookRequest(varBulkWritableJobHookRequest)
...
type NullableBulkWritableJobHookRequest struct {
	value *BulkWritableJobHookRequest
	isSet bool
}

func (v NullableBulkWritableJobHookRequest) Get() *BulkWritableJobHookRequest {
	return v.value
}

func (v *NullableBulkWritableJobHookRequest) Set(val *BulkWritableJobHookRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkWritableJobHookRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkWritableJobHookRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkWritableJobHookRequest(val *BulkWritableJobHookRequest) *NullableBulkWritableJobHookRequest {
	return &NullableBulkWritableJobHookRequest{value: val, isSet: true}
}

func (v NullableBulkWritableJobHookRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkWritableJobHookRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
