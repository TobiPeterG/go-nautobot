...
// PatchedInventoryItemRequest Add a `tree_depth` field to non-nested model serializers based on django-tree-queries.
...
func (o *PatchedInventoryItemRequest) SetSoftwareVersionNil() {
