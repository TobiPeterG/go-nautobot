...
type PatchedBulkWritableInterfaceRequest struct {
	...
	// For a child interface of a breakout-cable trunk, the position on the parent interface's trunk connector that this child interface maps to.
	BreakoutPosition NullableInt32 `json:"breakout_position,omitempty"`
...
// SetMode gets a reference to the given InterfaceModeChoices and assigns it to the Mode field.
...
func (o *PatchedBulkWritableInterfaceRequest) SetSpeedNil() {
	o.Speed.Set(nil)
}
...
// SetDuplex gets a reference to the given DuplexEnum and assigns it to the Duplex field.
...
// GetBreakoutPosition returns the BreakoutPosition field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *PatchedBulkWritableInterfaceRequest) GetBreakoutPosition() int32 {
	if o == nil || IsNil(o.BreakoutPosition.Get()) {
		var ret int32
		return ret
	}
	return *o.BreakoutPosition.Get()
}

// GetBreakoutPositionOk returns a tuple with the BreakoutPosition field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *PatchedBulkWritableInterfaceRequest) GetBreakoutPositionOk() (*int32, bool) {
	...
	return o.BreakoutPosition.Get(), o.BreakoutPosition.IsSet()
}
...
func (o *PatchedBulkWritableInterfaceRequest) HasBreakoutPosition() bool {
	if o != nil && o.BreakoutPosition.IsSet() {
		return true
	}
...
// SetBreakoutPosition gets a reference to the given NullableInt32 and assigns it to the BreakoutPosition field.
func (o *PatchedBulkWritableInterfaceRequest) SetBreakoutPosition(v int32) {
	o.BreakoutPosition.Set(&v)
}
// SetBreakoutPositionNil sets the value for BreakoutPosition to be an explicit nil
func (o *PatchedBulkWritableInterfaceRequest) SetBreakoutPositionNil() {
	o.BreakoutPosition.Set(nil)
}
...
func (o PatchedBulkWritableInterfaceRequest) ToMap() (map[string]interface{}, error) {
	...
	if o.BreakoutPosition.IsSet() {
		toSerialize["breakout_position"] = o.BreakoutPosition.Get()
	}
	if o.Device.IsSet() {
...
func (o *PatchedBulkWritableInterfaceRequest) UnmarshalJSON(data []byte) (err error) {
	...
	*o = PatchedBulkWritableInterfaceRequest(varPatchedBulkWritableInterfaceRequest)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "breakout_position")
