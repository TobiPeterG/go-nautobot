...
// checks if the IPAddressToInterfaceRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IPAddressToInterfaceRequest{}

// IPAddressToInterfaceRequest Extends the built-in ModelSerializer to enforce calling full_clean() on a copy of the associated instance during validation. (DRF does not do this by default; see https://github.com/encode/django-rest-framework/issues/3144)
type IPAddressToInterfaceRequest struct {
...
type _IPAddressToInterfaceRequest IPAddressToInterfaceRequest
...
func NewIPAddressToInterfaceRequest(ipAddress ApprovalWorkflowStageResponseApprovalWorkflowStage) *IPAddressToInterfaceRequest {
	this := IPAddressToInterfaceRequest{}
...
func (o *IPAddressToInterfaceRequest) SetInterfaceNil() {
	o.Interface.Set(nil)
}
...
func (o *IPAddressToInterfaceRequest) SetVmInterfaceNil() {
...
func (o IPAddressToInterfaceRequest) MarshalJSON() ([]byte, error) {
...
func (o IPAddressToInterfaceRequest) ToMap() (map[string]interface{}, error) {
...
func (o *IPAddressToInterfaceRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varIPAddressToInterfaceRequest := _IPAddressToInterfaceRequest{}

	err = json.Unmarshal(data, &varIPAddressToInterfaceRequest)

	if err != nil {
		return err
	}

	*o = IPAddressToInterfaceRequest(varIPAddressToInterfaceRequest)
...
type NullableIPAddressToInterfaceRequest struct {
	value *IPAddressToInterfaceRequest
	isSet bool
}

func (v NullableIPAddressToInterfaceRequest) Get() *IPAddressToInterfaceRequest {
	return v.value
}

func (v *NullableIPAddressToInterfaceRequest) Set(val *IPAddressToInterfaceRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableIPAddressToInterfaceRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableIPAddressToInterfaceRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIPAddressToInterfaceRequest(val *IPAddressToInterfaceRequest) *NullableIPAddressToInterfaceRequest {
	return &NullableIPAddressToInterfaceRequest{value: val, isSet: true}
}

func (v NullableIPAddressToInterfaceRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIPAddressToInterfaceRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
