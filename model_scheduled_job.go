...
type ScheduledJob struct {
	...
	State ScheduledJobState `json:"state"`
	...
	JobQueue NullableJobQueueOverride `json:"job_queue,omitempty"`
...
// GetJobQueue returns the JobQueue field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *ScheduledJob) GetJobQueue() JobQueueOverride {
	if o == nil || IsNil(o.JobQueue.Get()) {
		var ret JobQueueOverride
		return ret
	}
	return *o.JobQueue.Get()
}
...
// SetJobQueue gets a reference to the given NullableJobQueueOverride and assigns it to the JobQueue field.
func (o *ScheduledJob) SetJobQueue(v JobQueueOverride) {
	o.JobQueue.Set(&v)
}
// SetJobQueueNil sets the value for JobQueue to be an explicit nil
func (o *ScheduledJob) SetJobQueueNil() {
	o.JobQueue.Set(nil)
}
...
func (o ScheduledJob) ToMap() (map[string]interface{}, error) {
	...
	if o.JobQueue.IsSet() {
		toSerialize["job_queue"] = o.JobQueue.Get()
	}
	if o.User.IsSet() {
