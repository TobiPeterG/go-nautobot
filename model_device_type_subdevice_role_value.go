...
// DeviceTypeSubdeviceRoleValue the model 'DeviceTypeSubdeviceRoleValue'
...
const (
	...
	DEVICETYPESUBDEVICEROLEVALUE_PARENT_CHILD DeviceTypeSubdeviceRoleValue = "parent-child"
)
