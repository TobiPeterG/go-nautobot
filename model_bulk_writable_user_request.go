...
func (o *BulkWritableUserRequest) GetGroups() []ApprovalWorkflowStageResponseApprovalWorkflowStage {
...
// and a boolean to check if the value has been set.
func (o *BulkWritableUserRequest) GetGroupsOk() ([]ApprovalWorkflowStageResponseApprovalWorkflowStage, bool) {
	if o == nil || IsNil(o.Groups) {
		return nil, false
	}
...
func (o *BulkWritableUserRequest) SetGroups(v []ApprovalWorkflowStageResponseApprovalWorkflowStage) {
	o.Groups = v
}
