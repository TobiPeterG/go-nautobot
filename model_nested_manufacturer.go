...
// NestedManufacturer Base class to use for serializers based on OrganizationalModel or PrimaryModel.  Can also be used for models derived from BaseModel, so long as they support custom fields, notes, and relationships.
...
func (o *NestedManufacturer) GetObjectType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *NestedManufacturer) GetObjectTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *NestedManufacturer) SetObjectType(v string) {
	o.ObjectType = v
}
