...
type PatchedInterfaceRedundancyGroupAssociationRequest struct {
	...
	InterfaceRedundancyGroup *ApprovalWorkflowStageResponseApprovalWorkflowStage `json:"interface_redundancy_group,omitempty"`
...
func (o *PatchedInterfaceRedundancyGroupAssociationRequest) GetId() string {
	if o == nil || IsNil(o.Id) {
		var ret string
		return ret
	}
...
func (o *PatchedInterfaceRedundancyGroupAssociationRequest) GetIdOk() (*string, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *PatchedInterfaceRedundancyGroupAssociationRequest) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *PatchedInterfaceRedundancyGroupAssociationRequest) SetId(v string) {
	o.Id = &v
}
...
func (o *PatchedInterfaceRedundancyGroupAssociationRequest) GetInterfaceRedundancyGroup() ApprovalWorkflowStageResponseApprovalWorkflowStage {
...
// and a boolean to check if the value has been set.
func (o *PatchedInterfaceRedundancyGroupAssociationRequest) GetInterfaceRedundancyGroupOk() (*ApprovalWorkflowStageResponseApprovalWorkflowStage, bool) {
	if o == nil || IsNil(o.InterfaceRedundancyGroup) {
		return nil, false
	}
...
// SetInterfaceRedundancyGroup gets a reference to the given ApprovalWorkflowStageResponseApprovalWorkflowStage and assigns it to the InterfaceRedundancyGroup field.
func (o *PatchedInterfaceRedundancyGroupAssociationRequest) SetInterfaceRedundancyGroup(v ApprovalWorkflowStageResponseApprovalWorkflowStage) {
	o.InterfaceRedundancyGroup = &v
}

// GetInterface returns the Interface field value if set, zero value otherwise.
func (o *PatchedInterfaceRedundancyGroupAssociationRequest) GetInterface() ApprovalWorkflowStageResponseApprovalWorkflowStage {
...
// and a boolean to check if the value has been set.
func (o *PatchedInterfaceRedundancyGroupAssociationRequest) GetInterfaceOk() (*ApprovalWorkflowStageResponseApprovalWorkflowStage, bool) {
	if o == nil || IsNil(o.Interface) {
		return nil, false
	}
...
func (o *PatchedInterfaceRedundancyGroupAssociationRequest) SetInterface(v ApprovalWorkflowStageResponseApprovalWorkflowStage) {
	o.Interface = &v
}
