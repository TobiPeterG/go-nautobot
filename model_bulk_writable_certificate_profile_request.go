...
// checks if the BulkWritableCertificateProfileRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BulkWritableCertificateProfileRequest{}

// BulkWritableCertificateProfileRequest CertificateProfile Serializer.
type BulkWritableCertificateProfileRequest struct {
	Id string `json:"id"`
...
type _BulkWritableCertificateProfileRequest BulkWritableCertificateProfileRequest
...
func NewBulkWritableCertificateProfileRequest(id string, name string) *BulkWritableCertificateProfileRequest {
	this := BulkWritableCertificateProfileRequest{}
	this.Id = id
	this.Name = name
	return &this
}
...
func (o *BulkWritableCertificateProfileRequest) SetExpirationDateNil() {
...
func (o *BulkWritableCertificateProfileRequest) SetTenantNil() {
	o.Tenant.Set(nil)
}
...
func (o BulkWritableCertificateProfileRequest) MarshalJSON() ([]byte, error) {
...
func (o BulkWritableCertificateProfileRequest) ToMap() (map[string]interface{}, error) {
...
func (o *BulkWritableCertificateProfileRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varBulkWritableCertificateProfileRequest := _BulkWritableCertificateProfileRequest{}

	err = json.Unmarshal(data, &varBulkWritableCertificateProfileRequest)

	if err != nil {
		return err
	}

	*o = BulkWritableCertificateProfileRequest(varBulkWritableCertificateProfileRequest)
...
type NullableBulkWritableCertificateProfileRequest struct {
	value *BulkWritableCertificateProfileRequest
	isSet bool
}

func (v NullableBulkWritableCertificateProfileRequest) Get() *BulkWritableCertificateProfileRequest {
	return v.value
}

func (v *NullableBulkWritableCertificateProfileRequest) Set(val *BulkWritableCertificateProfileRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableBulkWritableCertificateProfileRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableBulkWritableCertificateProfileRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBulkWritableCertificateProfileRequest(val *BulkWritableCertificateProfileRequest) *NullableBulkWritableCertificateProfileRequest {
	return &NullableBulkWritableCertificateProfileRequest{value: val, isSet: true}
}

func (v NullableBulkWritableCertificateProfileRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBulkWritableCertificateProfileRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
