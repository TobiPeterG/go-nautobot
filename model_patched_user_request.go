...
func (o *PatchedUserRequest) GetId() string {
	if o == nil || IsNil(o.Id) {
		var ret string
		return ret
	}
...
func (o *PatchedUserRequest) GetIdOk() (*string, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *PatchedUserRequest) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *PatchedUserRequest) SetId(v string) {
	o.Id = &v
}
...
func (o *PatchedUserRequest) GetGroups() []ApprovalWorkflowStageResponseApprovalWorkflowStage {
...
// and a boolean to check if the value has been set.
func (o *PatchedUserRequest) GetGroupsOk() ([]ApprovalWorkflowStageResponseApprovalWorkflowStage, bool) {
	if o == nil || IsNil(o.Groups) {
		return nil, false
	}
...
func (o *PatchedUserRequest) SetGroups(v []ApprovalWorkflowStageResponseApprovalWorkflowStage) {
	o.Groups = v
}
