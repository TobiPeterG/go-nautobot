...
// checks if the VPNPhase1PolicyRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VPNPhase1PolicyRequest{}

// VPNPhase1PolicyRequest VPNPhase1Policy Serializer.
type VPNPhase1PolicyRequest struct {
...
type _VPNPhase1PolicyRequest VPNPhase1PolicyRequest
...
func (o *VPNPhase1PolicyRequest) SetLifetimeSecondsNil() {
...
func (o *VPNPhase1PolicyRequest) SetLifetimeKbNil() {
...
func (o *VPNPhase1PolicyRequest) SetTenantNil() {
	o.Tenant.Set(nil)
}
...
func (o VPNPhase1PolicyRequest) MarshalJSON() ([]byte, error) {
...
func (o VPNPhase1PolicyRequest) ToMap() (map[string]interface{}, error) {
...
func (o *VPNPhase1PolicyRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varVPNPhase1PolicyRequest := _VPNPhase1PolicyRequest{}

	err = json.Unmarshal(data, &varVPNPhase1PolicyRequest)

	if err != nil {
		return err
	}

	*o = VPNPhase1PolicyRequest(varVPNPhase1PolicyRequest)
...
type NullableVPNPhase1PolicyRequest struct {
	value *VPNPhase1PolicyRequest
	isSet bool
}

func (v NullableVPNPhase1PolicyRequest) Get() *VPNPhase1PolicyRequest {
	return v.value
}

func (v *NullableVPNPhase1PolicyRequest) Set(val *VPNPhase1PolicyRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableVPNPhase1PolicyRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableVPNPhase1PolicyRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVPNPhase1PolicyRequest(val *VPNPhase1PolicyRequest) *NullableVPNPhase1PolicyRequest {
	return &NullableVPNPhase1PolicyRequest{value: val, isSet: true}
}

func (v NullableVPNPhase1PolicyRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVPNPhase1PolicyRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
