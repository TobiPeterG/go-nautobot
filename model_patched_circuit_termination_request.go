...
type PatchedCircuitTerminationRequest struct {
	...
	Circuit *ApprovalWorkflowStageResponseApprovalWorkflowStage `json:"circuit,omitempty"`
...
// SetCircuit gets a reference to the given ApprovalWorkflowStageResponseApprovalWorkflowStage and assigns it to the Circuit field.
